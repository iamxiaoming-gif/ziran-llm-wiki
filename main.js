...
${a.map(o=>`- ${o.path}`).join(`
`)}`}:{success:!1,content:`\u6587\u4EF6\u4E0D\u5B58\u5728: ${t.path}`}}let n=t.new_leaf==="true";return await this.app.workspace.getLeaf(n).openFile(e),{success:!0,content:`\u5DF2\u5728 Obsidian \u4E2D\u6253\u5F00: ${e.path}`}}catch(t){return{success:!1,content:`\u6253\u5F00\u6587\u4EF6\u5931\u8D25: ${this.getErrorMessage(t)}`}}}})}registerSkillTools(){this.tools.set("read_skill",{name:"read_skill",description:"\u8BFB\u53D6 SKILL.md \u6587\u4EF6\u6216 references/ \u4E2D\u7684\u53C2\u8003\u6A21\u677F\u6587\u4EF6\u3002\u7528\u4E8E\u968F\u65F6\u67E5\u9605\u77E5\u8BC6\u5E93\u6784\u5EFA\u89C4\u8303\u539F\u6587",parameters:{type:"object",properties:{file:{type:"string",description:"\u8981\u8BFB\u53D6\u7684\u6587\u4EF6\u540D\u3002\u53EF\u9009\u503C\uFF1ASKILL.md\uFF08\u4E3B\u89C4\u8303\uFF09\u3001\u77E5\u8BC6\u70B9\u9875\u9762\u6A21\u677F.md\u3001\u4EBA\u7269\u4F20\u8BB0\u6A21\u677F.md\u3001\u7EC4\u7EC7\u6863\u6848\u6A21\u677F.md\u3001\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15\u6A21\u677F.md\u3001\u66F4\u65B0\u65E5\u5FD7\u6A21\u677F.md\u3001AGENTS-template.md"}},required:["file"]},execute:async s=>{try{let t=this.strArgs(s),e=(0,u.normalizePath)(this.settings.skillFolderPath),n=`${e}/references`,r;t.file==="SKILL.md"?r=`${e}/SKILL.md`:r=`${n}/${t.file}`;let i=this.app.vault.getAbstractFileByPath((0,u.normalizePath)(r));if(i&&i instanceof u.TFile){let a=await this.app.vault.read(i);if(a.trim())return{success:!0,content:a}}return t.file==="SKILL.md"?{success:!0,content:Et}:W[t.file]?{success:!0,content:W[t.file]}:{success:!1,content:`\u6587\u4EF6\u4E0D\u5B58\u5728\u4E14\u65E0\u5185\u7F6E\u7248\u672C: ${r}\u3002Skill \u6587\u4EF6\u5939\u8DEF\u5F84: ${this.settings.skillFolderPath}`}}catch(t){return{success:!1,content:`\u8BFB\u53D6\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("init_knowledge_base",{name:"init_knowledge_base",description:"\u521D\u59CB\u5316\u4E13\u9898\u77E5\u8BC6\u5E93\u76EE\u5F55\u7ED3\u6784\u3002\u5982\u679C\u4E0D\u4F20 categories\uFF0C\u5219\u521B\u5EFA\u6700\u5C0F\u7ED3\u6784\uFF0C\u7B49\u6444\u53D6\u8D44\u6599\u540E\u518D\u6839\u636E\u5185\u5BB9\u81EA\u52A8\u521B\u5EFA\u5206\u7C7B\uFF1B\u5982\u679C\u4F20\u4E86 categories\uFF0C\u5219\u6309\u6307\u5B9A\u5206\u7C7B\u521B\u5EFA",parameters:{type:"object",properties:{topic_name:{type:"string",description:"\u4E13\u9898\u540D\u79F0\uFF0C\u5982'\u5DF4\u83F2\u7279\u6295\u8D44'\u3001'Python\u7F16\u7A0B'"},categories:{type:"string",description:"\u77E5\u8BC6\u70B9\u5E93\u5206\u7C7B\uFF0C\u9017\u53F7\u5206\u9694\uFF08\u53EF\u9009\uFF09\u3002\u5982\u679C\u4E0D\u4F20\uFF0C\u5C06\u5728\u6444\u53D6\u8D44\u6599\u540E\u6839\u636E\u5185\u5BB9\u81EA\u52A8\u63A8\u8350\u5206\u7C7B"},raw_categories:{type:"string",description:"\u539F\u59CB\u8D44\u6599\u5206\u7C7B\uFF0C\u9017\u53F7\u5206\u9694\uFF08\u53EF\u9009\uFF09\u3002\u5982\u679C\u4E0D\u4F20\uFF0C\u53EA\u521B\u5EFA\u4E00\u4E2A\u9ED8\u8BA4\u7684'\u8D44\u6599'\u5206\u7C7B"}},required:["topic_name"]},execute:async s=>{try{let t=this.strArgs(s),e=(0,u.normalizePath)(this.settings.knowledgeBasePath),n=t.categories?t.categories.split(",").map(f=>f.trim()).filter(Boolean):[],r=t.raw_categories?t.raw_categories.split(",").map(f=>f.trim()).filter(Boolean):["\u8D44\u6599"],i=[e,`${e}/00-\u539F\u59CB\u8D44\u6599`,`${e}/00-\u539F\u59CB\u8D44\u6599/assets`,`${e}/10-\u77E5\u8BC6\u70B9\u5E93`,`${e}/20-\u77E5\u8BC6\u7D22\u5F15`,`${e}/30-\u7EF4\u62A4\u8BB0\u5F55`];for(let f of r)i.push(`${e}/00-\u539F\u59CB\u8D44\u6599/${f}`);for(let f of n)i.push(`${e}/10-\u77E5\u8BC6\u70B9\u5E93/${f}`);for(let f of i)await this.ensureFolder(f);let a;n.length>0?a=n.map((f,S)=>`### ${S+1}. ${f}\uFF080\u4E2A\uFF09\u{1F534}
...
`;return await this.createFileOnly(i,x+t.content),{success:!0,content:`\u77E5\u8BC6\u70B9\u9875\u9762\u5DF2\u521B\u5EFA: ${i}\uFF08\u542B YAML frontmatter\uFF09
...
`;return await this.createFileOnly(i,$+S),{success:!0,content:`\u77E5\u8BC6\u70B9\u9875\u9762\u5DF2\u521B\u5EFA: ${i}
...
`;await this.createFileOnly(p,f+n.content);let S=n.entry_category||c,v=`${r}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,$=this.app.vault.getAbstractFileByPath((0,u.normalizePath)(v));if($&&$ instanceof u.TFile){let _=await this.app.vault.read($),G=S.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),Ft=new RegExp(`###\\s+\\d+\\.\\s+${G}\\s*\\(\\d+\u4E2A\\)`),_t=_.match(Ft);if(_t){let z=_.indexOf(_t[0]),N=_.indexOf(`
### `,z+1),P=N===-1?_.indexOf(`
...
`+J+`
`+_.substring(P);await this.app.vault.modify($,X);let Q=X.match(/知识点总数：(\d+)个/);if(Q){let Dt=parseInt(Q[1])+1;await this.app.vault.modify($,X.replace(`\u77E5\u8BC6\u70B9\u603B\u6570\uFF1A${Q[1]}\u4E2A`,`\u77E5\u8BC6\u70B9\u603B\u6570\uFF1A${Dt}\u4E2A`))}}if(n.keywords){let z=`${r}/20-\u77E5\u8BC6\u7D22\u5F15/\u5173\u952E\u8BCD\u7D22\u5F15.md`,N=this.app.vault.getAbstractFileByPath((0,u.normalizePath)(z));if(N&&N instanceof u.TFile){let P=await this.app.vault.read(N),st=n.keywords.split(",").map(F=>F.trim()).filter(Boolean);for(let F of st){let nt=new RegExp(`\\|\\s*${F.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}\\s*\\|\\s*\\[\\[([^\\]]+)\\]\\]\\s*\\|\\s*(\\d+)\\s*\\|`),H=P.match(nt);if(H){let J=H[1],X=parseInt(H[2]),Q=J.includes(n.title)?J:`${J}, [[${n.title}]]`;P=P.replace(H[0],`| ${F} | ${Q} | ${X+1} |`)}else P=P.replace("\uFF08\u6682\u65E0\u5173\u952E\u8BCD\uFF09",`| ${F} | [[${n.title}]] | 1 |
\uFF08\u6682\u65E0\u5173\u952E\u8BCD\uFF09`)}P=P.replace(`
\uFF08\u6682\u65E0\u5173\u952E\u8BCD\uFF09`,"").replace("\uFF08\u6682\u65E0\u5173\u952E\u8BCD\uFF09",""),await this.app.vault.modify(N,P)}}}let y=`${r}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u70B9\u5173\u7CFB\u56FE\u8C31.md`,m=this.app.vault.getAbstractFileByPath((0,u.normalizePath)(y));if(m&&m instanceof u.TFile){let _=await this.app.vault.read(m),G=`- [[${n.title}]] (${c})`;await this.app.vault.modify(m,_.replace("\uFF08\u6682\u65E0\u8282\u70B9\uFF09",G))}let k=(0,u.normalizePath)(`${r}/10-\u77E5\u8BC6\u70B9\u5E93`),x=await this.addBacklinksToExisting(n.title,k),T=this.app.vault.getAbstractFileByPath((0,u.normalizePath)(p));if(T&&T instanceof u.TFile){let _=await this.app.vault.read(T);if(_.includes("## \u4E5D\u3001\u66F4\u65B0\u65E5\u5FD7")){let G=_.replace(/## 九、更新日志\n/,`## \u4E5D\u3001\u66F4\u65B0\u65E5\u5FD7

| \u65E5\u671F | \u64CD\u4F5C\u7C7B\u578B | \u89E6\u53D1\u6765\u6E90 | \u53D8\u66F4\u5185\u5BB9 |
|------|---------|---------|---------|
| ${i} | \u521B\u5EFA | \u7528\u6237\u6307\u4EE4 | \u521D\u59CB\u5316\u9875\u9762 |
`);await this.app.vault.modify(T,G)}}await this.updateAgentsMd(r,c);let j=`${r}/30-\u7EF4\u62A4\u8BB0\u5F55/\u77E5\u8BC6\u5E93\u66F4\u65B0\u65E5\u5FD7.md`,q=this.app.vault.getAbstractFileByPath((0,u.normalizePath)(j)),et=`
## ${i} | \u65B0\u5EFA\u77E5\u8BC6\u70B9\uFF1A${n.title}
...
`,l+="\u8BF7\u6839\u636E\u4EE5\u4E0A\u7D22\u5F15\u4FE1\u606F\uFF0C\u4F7F\u7528 read_vault_file \u5DE5\u5177\u8BFB\u53D6\u76F8\u5173\u77E5\u8BC6\u70B9\u9875\u9762\u7684\u8BE6\u7EC6\u5185\u5BB9\u6765\u56DE\u7B54\u7528\u6237\u95EE\u9898\u3002",{success:!0,content:l}}catch(t){return{success:!1,content:`\u67E5\u8BE2\u77E5\u8BC6\u5E93\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("lint_knowledge_base",{name:"lint_knowledge_base",description:"\u5BF9\u77E5\u8BC6\u5E93\u6267\u884C\u5B8C\u6574\u7684 Lint \u68C0\u67E5\uFF0C\u751F\u6210 Lint \u62A5\u544A\u5E76\u66F4\u65B0\u7EF4\u62A4\u65E5\u5FD7\u3002\u68C0\u67E5\u9879\u5305\u62EC\uFF1A\u77DB\u76FE\u3001\u5B64\u7ACB\u9875\u9762\u3001\u6B7B\u94FE\u3001\u683C\u5F0F\u95EE\u9898\u3001\u7A7A\u6587\u4EF6\u3001\u7AE0\u8282\u5B8C\u6574\u6027\u3001\u7D22\u5F15\u540C\u6B65\u7B49\u3002",parameters:{type:"object",properties:{check_type:{type:"string",description:"\u68C0\u67E5\u7C7B\u578B",enum:["full","format","content","links"]}},required:[]},execute:async s=>{try{let t=this.strArgs(s),e=(0,u.normalizePath)(this.settings.knowledgeBasePath),n=t.check_type||"full",r=new Date().toISOString().split("T")[0],i=[],a=`${e}/10-\u77E5\u8BC6\u70B9\u5E93`,o=this.app.vault.getAbstractFileByPath((0,u.normalizePath)(a));if(!o||!(o instanceof u.TFolder))return{success:!1,content:`\u77E5\u8BC6\u70B9\u5E93\u76EE\u5F55\u4E0D\u5B58\u5728: ${a}`};let c=[],l=[],p=new Set,d=m=>{for(let k of m.children)k instanceof u.TFile?(c.push(k),p.add(k.basename),k.stat.size===0&&l.push(k)):k instanceof u.TFolder&&d(k)};if(d(o),n==="full"||n==="format")for(let m of c){let k=await this.app.vault.read(m);k.includes("## \u4E00\u3001\u6838\u5FC3\u5B9A\u4E49")||i.push(`\u{1F4DD} ${m.basename} \u7F3A\u5C11"\u6838\u5FC3\u5B9A\u4E49"\u7AE0\u8282`),k.includes("## \u516D\u3001\u76F8\u5173\u77E5\u8BC6\u70B9")||i.push(`\u{1F4DD} ${m.basename} \u7F3A\u5C11"\u76F8\u5173\u77E5\u8BC6\u70B9"\u7AE0\u8282`),k.includes("## \u4E03\u3001\u539F\u6587\u51FA\u5904")||i.push(`\u{1F4DD} ${m.basename} \u7F3A\u5C11"\u539F\u6587\u51FA\u5904"\u7AE0\u8282`),k.includes("## \u4E5D\u3001\u66F4\u65B0\u65E5\u5FD7")||i.push(`\u{1F4DD} ${m.basename} \u7F3A\u5C11"\u66F4\u65B0\u65E5\u5FD7"\u7AE0\u8282`),k.includes("## \u516B\u3001\u5BF9")||i.push(`\u{1F4DD} ${m.basename} \u7F3A\u5C11"\u542F\u793A"\u7AE0\u8282`)}if(n==="full"||n==="links"){let m=[],k=new Set,x=new Set;for(let T of c){let q=(await this.app.vault.read(T)).matchAll(/\[\[([^\]]+)\]\]/g);for(let et of q){let _=et[1].split("|")[0].split("#")[0].trim();k.add(_),p.has(_)||x.add(_)}}for(let T of p)k.has(T)||m.push(T);m.length>0&&i.push(`\u{1F517} \u53D1\u73B0 ${m.length} \u4E2A\u5B64\u7ACB\u9875\u9762\uFF08\u65E0\u5165\u94FE\uFF09:
${m.slice(0,20).map(T=>`  - ${T}`).join(`
`)}`),x.size>0&&i.push(`\u{1F480} \u53D1\u73B0 ${x.size} \u4E2A\u6B7B\u94FE\uFF08\u94FE\u63A5\u6307\u5411\u4E0D\u5B58\u5728\u7684\u9875\u9762\uFF09:
${[...x].slice(0,20).map(T=>`  - [[${T}]]`).join(`
`)}`)}if(n==="full"||n==="content"){let m=`${e}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,k=this.app.vault.getAbstractFileByPath((0,u.normalizePath)(m));if(k&&k instanceof u.TFile){let T=(await this.app.vault.read(k)).matchAll(/\((\d+)个\)/g);for(let j of T)parseInt(j[1])>0&&i.push(`\u{1F4CA} \u5206\u7C7B\u8BA1\u6570 ${j[0]} \u9700\u8981\u9A8C\u8BC1\u662F\u5426\u4E0E\u5B9E\u9645\u6587\u4EF6\u6570\u4E00\u81F4`)}}let g=`${e}/30-\u7EF4\u62A4\u8BB0\u5F55/\u77E5\u8BC6\u5E93 Lint \u62A5\u544A.md`,b=`# \u77E5\u8BC6\u5E93 Lint \u62A5\u544A
...
- \u603B\u6587\u4EF6\u6570: ${c.length}
- \u7A7A\u6587\u4EF6\u6570: ${l.length}
- \u5B64\u7ACB\u9875\u9762\u6570: ${i.filter(m=>m.includes("\u5B64\u7ACB\u9875\u9762")).length}
- \u6B7B\u94FE\u6570: ${i.filter(m=>m.includes("\u6B7B\u94FE")).length}
- \u683C\u5F0F\u95EE\u9898\u6570: ${i.filter(m=>m.includes("\u{1F4DD}")).length}
...
## \u683C\u5F0F\u9677\u9631
${s.formatTraps}`}function $t(h){let s=(...g)=>{for(let b of g){let f=b.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),S=new RegExp(`##\\s*[\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341]*[\u3001.]?\\s*${f}[\\s\\S]*?(?=\\n##\\s|$)`,"i"),v=h.match(S);if(v)return v[0].replace(/^##\s*[一二三四五六七八九十]*[、.]?\s*.*$/m,"").trim()}return""},t=h.match(/#\s+AGENTS\.md\s*[—–-]\s*(.+?)(?:知识库|维护|$)/i),e=t?t[1].trim():B.topicName,n=h.match(/>\s*基于\s*(.+?)[\n]/i)||h.match(/>\s*(.+?方法论.+?)[\n]/i),r=n?n[1].trim():B.topicDescription,i=s("\u6838\u5FC3\u539F\u5219","\u7EF4\u62A4\u539F\u5219","\u94C1\u5F8B")||B.maintenanceRules,a=s("\u6444\u53D6\u5DE5\u4F5C\u6D41","\u6444\u53D6","Ingest")||B.ingestWorkflow,o=s("\u67E5\u8BE2\u5DE5\u4F5C\u6D41","\u67E5\u8BE2","Query")||B.queryWorkflow,c=s("\u6574\u7406\u5DE5\u4F5C\u6D41","Lint","\u6574\u7406")||B.lintWorkflow,l=s("\u5199\u4F5C\u89C4\u8303","Writing")||B.writingRules,p=s("\u81EA\u68C0\u6E05\u5355")||B.checklistItems,d=s("\u683C\u5F0F\u9677\u9631","\u9677\u9631")||B.formatTraps;return{topicName:e,topicDescription:r,maintenanceRules:i,ingestWorkflow:a,queryWorkflow:o,lintWorkflow:c,writingRules:l,checklistItems:p,formatTraps:d}}var ot=class{constructor(s,t){this.app=s,this.settings=t}updateSettings(s){this.settings=s}async loadAgentsContext(s){try{let t=(0,I.normalizePath)(`${s}/AGENTS.md`),e=this.app.vault.getAbstractFileByPath(t);if(e&&e instanceof I.TFile){let n=await this.app.vault.read(e);if(n.trim())return $t(n)}}catch(t){}return null}async loadMemoryContext(){let s=[],t=(0,I.normalizePath)(`${this.settings.memoryFolder}/\u957F\u671F\u8BB0\u5FC6.md`),e=this.app.vault.getAbstractFileByPath(t);e&&e instanceof I.TFile&&s.push(await this.app.vault.read(e));let n=(0,I.normalizePath)(`${this.settings.memoryFolder}/\u7528\u6237\u504F\u597D.md`),r=this.app.vault.getAbstractFileByPath(n);return r&&r instanceof I.TFile&&s.push(await this.app.vault.read(r)),s.join(`
