var N=Object.defineProperty;var G=Object.getOwnPropertyDescriptor;var Y=Object.getOwnPropertyNames;var Q=Object.prototype.hasOwnProperty;var X=(w,e)=>{for(var t in e)N(w,t,{get:e[t],enumerable:!0})},Z=(w,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Y(e))!Q.call(w,s)&&s!==t&&N(w,s,{get:()=>e[s],enumerable:!(n=G(e,s))||n.enumerable});return w};var tt=w=>Z(N({},"__esModule",{value:!0}),w);var et={};X(et,{default:()=>j});module.exports=tt(et);var R=require("obsidian");var $=require("obsidian"),z={apiKey:"",apiBaseUrl:"https://api.openai.com/v1",modelName:"gpt-4o",knowledgeBasePath:"\u77E5\u8BC6\u5E93",memoryFolder:"\u8BB0\u5FC6",skillFolderPath:"\u77E5\u8BC6\u5E93",theme:"dark-blue",temperature:.7,maxIterations:15,autoLog:!0,streamMode:!0},E=class extends $.PluginSettingTab{constructor(t,n){super(t,n);this.plugin=n;let s=(0,$.debounce)(async()=>{await this.plugin.saveSettings()},500,!0);this.debouncedSave=()=>{s()}}display(){let{containerEl:t}=this;t.empty(),new $.Setting(t).setName("LLM Wiki \u77E5\u8BC6\u5E93\u52A9\u624B\u8BBE\u7F6E").setHeading(),new $.Setting(t).setName("API Key").setDesc("OpenAI \u517C\u5BB9 API \u5BC6\u94A5").addText(n=>{n.setPlaceholder("sk-...").setValue(this.plugin.settings.apiKey).onChange(async i=>{this.plugin.settings.apiKey=i,this.debouncedSave()});let s=n.inputEl;s.type="password"}),new $.Setting(t).setName("API Base URL").setDesc("OpenAI \u517C\u5BB9 API \u5730\u5740").addText(n=>n.setPlaceholder("https://api.openai.com/v1").setValue(this.plugin.settings.apiBaseUrl).onChange(async s=>{this.plugin.settings.apiBaseUrl=s,this.debouncedSave()})),new $.Setting(t).setName("\u6A21\u578B\u540D\u79F0").setDesc("\u4F7F\u7528\u7684\u6A21\u578B\uFF0C\u5982 gpt-4o\u3001deepseek-chat \u7B49").addText(n=>n.setPlaceholder("gpt-4o").setValue(this.plugin.settings.modelName).onChange(async s=>{this.plugin.settings.modelName=s,this.debouncedSave()})),new $.Setting(t).setName("\u77E5\u8BC6\u5E93\u8DEF\u5F84").setDesc("\u77E5\u8BC6\u5E93\u5728 Vault \u4E2D\u7684\u6839\u8DEF\u5F84").addText(n=>n.setPlaceholder("\u77E5\u8BC6\u5E93").setValue(this.plugin.settings.knowledgeBasePath).onChange(async s=>{this.plugin.settings.knowledgeBasePath=s,this.debouncedSave()})),new $.Setting(t).setName("Skill \u6587\u4EF6\u5939\u8DEF\u5F84").setDesc("\u5305\u542B SKILL.md \u548C references/ \u5B50\u6587\u4EF6\u5939\u7684\u76EE\u5F55\u8DEF\u5F84\uFF08\u4ECE vault \u6839\u76EE\u5F55\u5F00\u59CB\uFF09").addText(n=>n.setPlaceholder("\u77E5\u8BC6\u5E93").setValue(this.plugin.settings.skillFolderPath).onChange(async s=>{this.plugin.settings.skillFolderPath=s,this.debouncedSave()})),new $.Setting(t).setName("\u8BB0\u5FC6\u6587\u4EF6\u5939\u8DEF\u5F84").setDesc("Agent \u8BB0\u5FC6\u5B58\u50A8\u8DEF\u5F84").addText(n=>n.setPlaceholder("\u8BB0\u5FC6").setValue(this.plugin.settings.memoryFolder).onChange(async s=>{this.plugin.settings.memoryFolder=s,this.debouncedSave()})),new $.Setting(t).setName("\u4E3B\u9898").setDesc("\u754C\u9762\u4E3B\u9898\u98CE\u683C").addDropdown(n=>n.addOptions({"dark-blue":"\u6697\u591C\u84DD","warm-light":"\u6696\u767D","obsidian-red":"Obsidian \u7EA2",lavender:"\u85B0\u8863\u8349\u7D2B","forest-green":"\u58A8\u7EFF"}).setValue(this.plugin.settings.theme).onChange(async s=>{this.plugin.settings.theme=s,await this.plugin.saveSettings(),this.plugin.applyTheme()})),new $.Setting(t).setName("Temperature").setDesc("LLM \u751F\u6210\u6E29\u5EA6 (0-2)").addSlider(n=>n.setLimits(0,2,.1).setValue(this.plugin.settings.temperature).onChange(async s=>{this.plugin.settings.temperature=s,this.debouncedSave()})),new $.Setting(t).setName("\u6700\u5927\u8FED\u4EE3\u6B21\u6570").setDesc("Agent \u5DE5\u5177\u8C03\u7528\u6700\u5927\u8FED\u4EE3\u6B21\u6570").addSlider(n=>n.setLimits(1,30,1).setValue(this.plugin.settings.maxIterations).onChange(async s=>{this.plugin.settings.maxIterations=s,this.debouncedSave()})),new $.Setting(t).setName("\u6D41\u5F0F\u8F93\u51FA").setDesc("\u542F\u7528\u6D41\u5F0F\u8F93\u51FA\uFF08\u5B9E\u65F6\u663E\u793A\u56DE\u590D\uFF09").addToggle(n=>n.setValue(this.plugin.settings.streamMode).onChange(async s=>{this.plugin.settings.streamMode=s,await this.plugin.saveSettings()})),new $.Setting(t).setName("\u81EA\u52A8\u65E5\u5FD7").setDesc("\u5BF9\u8BDD\u5B8C\u6210\u540E\u81EA\u52A8\u8BB0\u5F55\u5DE5\u4F5C\u65E5\u5FD7").addToggle(n=>n.setValue(this.plugin.settings.autoLog).onChange(async s=>{this.plugin.settings.autoLog=s,await this.plugin.saveSettings()}))}};var W=require("obsidian");function H(w,e,t,n=""){let s=[],i=`\u4F60\u662F\u4E00\u4E2A\u77E5\u8BC6\u5E93\u6784\u5EFA\u4E0E\u7EF4\u62A4\u52A9\u624B\u3002\u4F60\u7684\u5DE5\u4F5C\u89C4\u8303\u3001\u539F\u5219\u3001\u5DE5\u4F5C\u6D41\u3001\u8D28\u91CF\u63A7\u5236\u6807\u51C6\u3001\u9875\u9762\u6A21\u677F\u7B49\u5168\u90E8\u5B9A\u4E49\u5728\u4E0B\u65B9\u300C\u77E5\u8BC6\u5E93\u6784\u5EFA\u89C4\u8303\u300D\u4E2D\u3002
...
\u77E5\u8BC6\u5E93\u6839\u8DEF\u5F84\uFF1A${w.knowledgeBasePath}/
\u8BB0\u5FC6\u5B58\u50A8\u8DEF\u5F84\uFF1A${w.memoryFolder}/
...
`)}var M=class{constructor(e,t){this.history=[];this.systemPrompt="";this.settings=e,this.toolRegistry=t}init(e="",t="",n=""){this.systemPrompt=H(this.settings,e,t,n),this.history=[]}setHistory(e){this.history=e}getHistory(){return this.history}clearHistory(){this.history=[]}updateSettings(e){this.settings=e,this.toolRegistry.updateSettings(e)}abort(){}async chatStream(e,t){this.history.push({role:"user",content:e});let n="",s=0,i=this.settings.maxIterations||15;for(;s<i;){s++;let c=[{role:"system",content:this.systemPrompt},...this.history];try{let l=await this.streamCompletion(c,t);if(n=l.content,l.toolCalls.length===0){this.history.push({role:"assistant",content:l.content}),t.onComplete(n);return}this.history.push({role:"assistant",content:l.content||"",tool_calls:l.toolCalls});for(let p of l.toolCalls){let h={};try{h=JSON.parse(p.function.arguments)}catch(r){h={}}t.onToolCall(p.function.name,h);let m=await this.toolRegistry.executeTool(p.function.name,h);t.onToolResult(p.function.name,m),this.history.push({role:"tool",content:m.content,tool_call_id:p.id,name:p.function.name})}}catch(l){if(l instanceof Error&&l.name==="AbortError"){t.onComplete(n);return}let p=`\u8BF7\u6C42\u5931\u8D25: ${l instanceof Error?l.message:String(l)}`;this.history.push({role:"assistant",content:p}),t.onError(p);return}}let o=`\u5DF2\u8FBE\u5230\u6700\u5927\u8FED\u4EE3\u6B21\u6570(${i})\uFF0C\u8BF7\u7B80\u5316\u95EE\u9898\u6216\u5206\u6B65\u6267\u884C\u3002`;this.history.push({role:"assistant",content:o}),t.onComplete(o)}async streamCompletion(e,t){var h;let n=`${this.settings.apiBaseUrl}/chat/completions`,s={model:this.settings.modelName,messages:e.map(m=>({role:m.role,content:m.content||null,tool_calls:m.tool_calls,tool_call_id:m.tool_call_id,name:m.name})),tools:this.toolRegistry.getToolDefinitions(),tool_choice:"auto",temperature:this.settings.temperature,stream:!1},o=(h=(await(0,W.requestUrl)({url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.settings.apiKey}`},body:JSON.stringify(s)})).json.choices)==null?void 0:h[0];if(!o)throw new Error("API \u8FD4\u56DE\u4E3A\u7A7A");let c=o.message||{},l=c.content||"",p=c.tool_calls||[];return l&&t.onToken(l),this.abortController=null,{content:l,toolCalls:p}}async chatNonStream(e,t){this.history.push({role:"user",content:e});let n="",s=0,i=this.settings.maxIterations||15;for(;s<i;){s++;let c=[{role:"system",content:this.systemPrompt},...this.history];try{let l=await this.nonStreamCompletion(c),p=l.content;if(l.toolCalls.length===0){t.onToken(p),this.history.push({role:"assistant",content:p}),n=p,t.onComplete(n);return}this.history.push({role:"assistant",content:p||"",tool_calls:l.toolCalls});for(let h of l.toolCalls){let m={};try{m=JSON.parse(h.function.arguments)}catch(d){m={}}t.onToolCall(h.function.name,m);let r=await this.toolRegistry.executeTool(h.function.name,m);t.onToolResult(h.function.name,r),this.history.push({role:"tool",content:r.content,tool_call_id:h.id,name:h.function.name})}}catch(l){let p=`\u8BF7\u6C42\u5931\u8D25: ${l instanceof Error?l.message:String(l)}`;this.history.push({role:"assistant",content:p}),t.onError(p);return}}let o=`\u5DF2\u8FBE\u5230\u6700\u5927\u8FED\u4EE3\u6B21\u6570(${i})`;this.history.push({role:"assistant",content:o}),t.onComplete(o)}async nonStreamCompletion(e){var i;let t=`${this.settings.apiBaseUrl}/chat/completions`,n={model:this.settings.modelName,messages:e.map(o=>({role:o.role,content:o.content||null,tool_calls:o.tool_calls,tool_call_id:o.tool_call_id,name:o.name})),tools:this.toolRegistry.getToolDefinitions(),tool_choice:"auto",temperature:this.settings.temperature,stream:!1},s=2;for(let o=0;o<=s;o++)try{let l=(i=(await(0,W.requestUrl)({url:t,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.settings.apiKey}`},body:JSON.stringify(n)})).json.choices)==null?void 0:i[0];if(!l)throw new Error("API \u8FD4\u56DE\u4E3A\u7A7A");let p=l.message||{};return{content:p.content||"",toolCalls:p.tool_calls||[]}}catch(c){let l=(c==null?void 0:c.status)||0;if(l>=400&&l<500)throw c;if(o<s)await new Promise(p=>window.setTimeout(p,1e3*(o+1)));else throw c}throw new Error("API \u8C03\u7528\u5931\u8D25\uFF08\u5DF2\u91CD\u8BD5\uFF09")}};var a=require("obsidian"),A=class{constructor(e,t){this.tools=new Map;this.app=e,this.settings=t,this.registerAllTools()}updateSettings(e){this.settings=e}registerAllTools(){this.registerVaultTools(),this.registerSkillTools(),this.registerMemoryTools()}registerVaultTools(){this.tools.set("read_vault_file",{name:"read_vault_file",description:"\u8BFB\u53D6 Vault \u4E2D\u7684\u6587\u4EF6\u5185\u5BB9",parameters:{type:"object",properties:{path:{type:"string",description:"\u6587\u4EF6\u5728 Vault \u4E2D\u7684\u76F8\u5BF9\u8DEF\u5F84"}},required:["path"]},execute:async e=>{try{let t=(0,a.normalizePath)(e.path),n=this.app.vault.getAbstractFileByPath(t);return!n||!(n instanceof a.TFile)?{success:!1,content:`\u6587\u4EF6\u4E0D\u5B58\u5728: ${t}`}:{success:!0,content:await this.app.vault.read(n)}}catch(t){return{success:!1,content:`\u8BFB\u53D6\u6587\u4EF6\u5931\u8D25: ${t.message}`}}}}),this.tools.set("write_vault_file",{name:"write_vault_file",description:"\u521B\u5EFA\u65B0\u6587\u4EF6\uFF08\u4E0D\u80FD\u5199\u5165 00-\u539F\u59CB\u8D44\u6599/ \u76EE\u5F55\u3002\u5982\u679C\u6587\u4EF6\u5DF2\u5B58\u5728\u5219\u62A5\u9519\uFF09",parameters:{type:"object",properties:{path:{type:"string",description:"\u6587\u4EF6\u5728 Vault \u4E2D\u7684\u76F8\u5BF9\u8DEF\u5F84\uFF08\u5FC5\u987B\u662F\u4E0D\u5B58\u5728\u7684\u8DEF\u5F84\uFF0C\u4E14\u4E0D\u80FD\u5728 00-\u539F\u59CB\u8D44\u6599/ \u4E0B\uFF09"},content:{type:"string",description:"\u6587\u4EF6\u5185\u5BB9"}},required:["path","content"]},execute:async e=>{try{let t=(0,a.normalizePath)(e.path),n=this.isUnderRawMaterials(t);if(n)return{success:!1,content:`\u7981\u6B62\u5199\u5165\u539F\u59CB\u8D44\u6599\u76EE\u5F55\uFF1A${n}\u300200-\u539F\u59CB\u8D44\u6599/ \u76EE\u5F55\u53EA\u8BFB\uFF0C\u4E0D\u80FD\u4FEE\u6539\u3002\u5982\u679C\u7528\u6237\u9700\u8981\u79FB\u52A8\u6587\u4EF6\uFF0C\u8BF7\u544A\u77E5\u7528\u6237\u624B\u52A8\u64CD\u4F5C\u3002`};let s=this.app.vault.getAbstractFileByPath(t);return s&&s instanceof a.TFile?{success:!1,content:`\u6587\u4EF6\u5DF2\u5B58\u5728\uFF0C\u7981\u6B62\u8986\u76D6\uFF1A${t}\u3002\u8BF7\u4F7F\u7528 append_vault_file \u8FFD\u52A0\u5185\u5BB9\uFF0C\u6216\u4F7F\u7528 update_knowledge_page \u66F4\u65B0\u9875\u9762\u7AE0\u8282\u3002`}:(await this.ensureFolder(t.substring(0,t.lastIndexOf("/"))),await this.app.vault.create(t,e.content),{success:!0,content:`\u6587\u4EF6\u5DF2\u521B\u5EFA: ${t}`})}catch(t){return{success:!1,content:`\u521B\u5EFA\u6587\u4EF6\u5931\u8D25: ${t.message}`}}}}),this.tools.set("append_vault_file",{name:"append_vault_file",description:"\u5728 Vault \u6587\u4EF6\u672B\u5C3E\u8FFD\u52A0\u5185\u5BB9\uFF08\u4E0D\u80FD\u4FEE\u6539 00-\u539F\u59CB\u8D44\u6599/ \u76EE\u5F55\u4E0B\u7684\u6587\u4EF6\uFF09",parameters:{type:"object",properties:{path:{type:"string",description:"\u6587\u4EF6\u5728 Vault \u4E2D\u7684\u76F8\u5BF9\u8DEF\u5F84"},content:{type:"string",description:"\u8981\u8FFD\u52A0\u7684\u5185\u5BB9"}},required:["path","content"]},execute:async e=>{try{let t=(0,a.normalizePath)(e.path),n=this.isUnderRawMaterials(t);if(n)return{success:!1,content:`\u7981\u6B62\u4FEE\u6539\u539F\u59CB\u8D44\u6599\u76EE\u5F55\uFF1A${n}\u300200-\u539F\u59CB\u8D44\u6599/ \u76EE\u5F55\u53EA\u8BFB\u3002`};let s=this.app.vault.getAbstractFileByPath(t);if(!s||!(s instanceof a.TFile))return{success:!1,content:`\u6587\u4EF6\u4E0D\u5B58\u5728: ${t}`};let i=await this.app.vault.read(s);return await this.app.vault.modify(s,i+`
...
${n.map((r,d)=>`### ${d+1}. ${r.trim()}\uFF080\u4E2A\uFF09\u{1F534}
...
\uFF08\u6682\u65E0\u5173\u7CFB\u6570\u636E\uFF09
`;await this.createFileOnly(`${t}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u70B9\u5173\u7CFB\u56FE\u8C31.md`,l);let p=`# \u77E5\u8BC6\u5E93\u66F4\u65B0\u65E5\u5FD7
...
---
`;await this.createFileOnly(`${t}/30-\u7EF4\u62A4\u8BB0\u5F55/\u77E5\u8BC6\u5E93\u66F4\u65B0\u65E5\u5FD7.md`,p);let h=`# \u51B2\u7A81\u4E0E\u9519\u8BEF\u8BB0\u5F55
...
\u2514\u2500\u2500 AGENTS.md
\`\`\`
`;try{let r=(0,a.normalizePath)(`${this.settings.skillFolderPath}/references/AGENTS-template.md`),d=this.app.vault.getAbstractFileByPath(r);d&&d instanceof a.TFile&&(m=(await this.app.vault.read(d)).replace(/\[专题名称\]/g,e.topic_name).replace(/\[专题名称\]/g,e.topic_name).replace(/YYYY-MM-DD/g,new Date().toISOString().split("T")[0]).replace(/\[方括号\]/g,""))}catch(r){}return await this.createFileOnly(`${t}/AGENTS.md`,m),{success:!0,content:`\u77E5\u8BC6\u5E93 "${e.topic_name}" \u5DF2\u521D\u59CB\u5316\u5B8C\u6210\uFF01
...
\u6216\u8005\u76F4\u63A5\u4F7F\u7528 create_and_index_page \u4E00\u7AD9\u5F0F\u5B8C\u6210\u4E0A\u8FF0\u5168\u90E8\u6B65\u9AA4\u3002`};let c=e.maturity?`${e.maturity}`:"\u57FA\u7840\u7EA7",l=c.includes("\u5B8C\u6574")?"\u{1F7E2}":c.includes("\u6846\u67B6")?"\u{1F534}":"\u{1F7E1}",p=`### \u8981\u70B91\uFF1A[\u5F85\u8865\u5145]

[\u5F85\u8865\u5145]`;if(e.key_points)try{p=JSON.parse(e.key_points).map((g,k)=>`### \u8981\u70B9${k+1}\uFF1A${g.name||g.title}

${g.content||g.description||""}`).join(`

`)}catch(y){p=e.key_points}let h=`### \u6848\u4F8B1\uFF1A[\u5F85\u8865\u5145]

[\u5F85\u8865\u5145]`;if(e.cases)try{h=JSON.parse(e.cases).map((g,k)=>`### \u6848\u4F8B${k+1}\uFF1A${g.name||g.title}

${g.content||g.description||""}`).join(`

`)}catch(y){h=e.cases}let m=`### \u65B9\u6CD51\uFF1A[\u5F85\u8865\u5145]

[\u5F85\u8865\u5145]`;if(e.methods)try{m=JSON.parse(e.methods).map((g,k)=>`### \u65B9\u6CD5${k+1}\uFF1A${g.name||g.title}

${g.content||g.description||""}`).join(`

`)}catch(y){m=e.methods}let r=`### \u8BEF\u533A1\uFF1A[\u5F85\u8865\u5145]

[\u5F85\u8865\u5145]`;if(e.misconceptions)try{r=JSON.parse(e.misconceptions).map((g,k)=>`### \u8BEF\u533A${k+1}\uFF1A${g.name||g.title}

${g.content||g.description||""}`).join(`

`)}catch(y){r=e.misconceptions}let d=(e.related_topics||"").split(",").filter(y=>y.trim()).map(y=>`- [[${y.trim()}]]`).join(`
`),u=(e.source_refs||"").split(",").filter(y=>y.trim()).map(y=>`- [[${y.trim()}]]`).join(`
`),f=`# ${e.title}
...
---
`;if(f&&f instanceof a.TFile){let g=await this.app.vault.read(f);await this.app.vault.modify(f,g+y)}else await this.createFileOnly(u,`# \u77E5\u8BC6\u5E93\u66F4\u65B0\u65E5\u5FD7
...
`)}catch(u){o=e.contributions}let c="> [\u5F85\u8865\u5145]";if(e.quotes)try{c=JSON.parse(e.quotes).map(f=>`> "${f.content||f.text}"
> \u2014\u2014 ${f.source||"\u51FA\u5904\u5F85\u8865\u5145"}`).join(`

`)}catch(u){c=e.quotes}let l=(e.related_topics||"").split(",").filter(u=>u.trim()).map(u=>`- [[${u.trim()}]]`).join(`
`),p=(e.related_orgs||"").split(",").filter(u=>u.trim()).map(u=>`- [[${u.trim()}]]`).join(`
`),h=(e.source_refs||"").split(",").filter(u=>u.trim()).map(u=>`- [[${u.trim()}]]`).join(`
`),m=`# ${e.name}
...
|------|---------|---------|----------|
| ${s} | \u521B\u5EFA | \u7528\u6237\u6307\u4EE4 | \u521D\u59CB\u5316\u9875\u9762 |
`,r=`${n}/${e.name}.md`,d=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(r));return d&&d instanceof a.TFile?{success:!1,content:`\u4EBA\u7269\u4F20\u8BB0\u9875\u9762\u5DF2\u5B58\u5728\uFF0C\u7981\u6B62\u8986\u76D6\uFF1A${r}\u3002\u8BF7\u4F7F\u7528 update_knowledge_page \u8FFD\u52A0\u5185\u5BB9\u3002`}:(await this.createFileOnly(r,m),{success:!0,content:`\u4EBA\u7269\u4F20\u8BB0\u9875\u9762\u5DF2\u521B\u5EFA: ${r}
...
[\u5F85\u8865\u5145]`;if(e.events)try{o=JSON.parse(e.events).map((u,f)=>`### \u4E8B\u4EF6${f+1}\uFF1A${u.name||u.title}

${u.content||u.description||""}`).join(`

`)}catch(d){o=e.events}let c=(e.key_figures||"").split(",").filter(d=>d.trim()).map(d=>`- [[${d.trim()}]]`).join(`
`),l=(e.related_topics||"").split(",").filter(d=>d.trim()).map(d=>`- [[${d.trim()}]]`).join(`
`),p=(e.source_refs||"").split(",").filter(d=>d.trim()).map(d=>`- [[${d.trim()}]]`).join(`
`),h=`# ${e.name}
...
1. \u4F7F\u7528 update_index \u5DE5\u5177\u66F4\u65B0\u7D22\u5F15
2. \u5728\u81F3\u5C113\u4E2A\u5DF2\u6709\u9875\u9762\u4E2D\u6DFB\u52A0\u5165\u94FE
3. \u8FFD\u52A0\u66F4\u65B0\u65E5\u5FD7`})}catch(t){return{success:!1,content:`\u521B\u5EFA\u7EC4\u7EC7\u6863\u6848\u9875\u9762\u5931\u8D25: ${t.message}`}}}}),this.tools.set("update_knowledge_page",{name:"update_knowledge_page",description:"\u5411\u5DF2\u6709\u7684\u77E5\u8BC6\u70B9\u9875\u9762\u8FFD\u52A0\u5185\u5BB9\u3002\u4E0D\u53EF\u66FF\u6362\u6216\u5220\u9664\u5DF2\u6709\u5185\u5BB9",parameters:{type:"object",properties:{path:{type:"string",description:"\u77E5\u8BC6\u70B9\u9875\u9762\u7684\u8DEF\u5F84"},section:{type:"string",description:"\u8981\u66F4\u65B0\u7684\u7AE0\u8282\u6838\u5FC3\u540D\u79F0\uFF0C\u5982\uFF1A\u6838\u5FC3\u5B9A\u4E49\u3001\u6838\u5FC3\u8981\u70B9\u3001\u7ECF\u5178\u6848\u4F8B\u3001\u5B9E\u8DF5\u65B9\u6CD5\u3001\u5E38\u89C1\u8BEF\u533A\u3001\u76F8\u5173\u77E5\u8BC6\u70B9\u3001\u539F\u6587\u51FA\u5904\u3001\u542F\u793A\u3001\u66F4\u65B0\u65E5\u5FD7"},content:{type:"string",description:"\u8981\u8FFD\u52A0\u7684\u7AE0\u8282\u5185\u5BB9\uFF08\u53EA\u5199\u7AE0\u8282\u5185\u5BB9\u672C\u8EAB\uFF0C\u4E0D\u5305\u542B\u7AE0\u8282\u6807\u9898\uFF09"},append_mode:{type:"string",description:"\u56FA\u5B9A\u4E3A append\uFF08\u5728\u7AE0\u8282\u672B\u5C3E\u8FFD\u52A0\u5185\u5BB9\uFF09\u3002\u6CE8\u610F\uFF1A\u4E0D\u652F\u6301 replace\uFF0C\u4E0D\u5F97\u5220\u9664\u5DF2\u6709\u5185\u5BB9",enum:["append"]}},required:["path","section","content"]},execute:async e=>{try{let t=(0,a.normalizePath)(e.path),n=this.app.vault.getAbstractFileByPath(t);if(!n||!(n instanceof a.TFile))return{success:!1,content:`\u6587\u4EF6\u4E0D\u5B58\u5728: ${t}`};let s=await this.app.vault.read(n),o={\u6838\u5FC3\u5B9A\u4E49:["\u6838\u5FC3\u5B9A\u4E49","\u6838\u5FC3\u5B9A\u4E49"],\u6838\u5FC3\u8981\u70B9:["\u6838\u5FC3\u8981\u70B9","\u8981\u70B9"],\u7ECF\u5178\u6848\u4F8B:["\u7ECF\u5178\u6848\u4F8B","\u6848\u4F8B"],\u5B9E\u8DF5\u65B9\u6CD5:["\u5B9E\u8DF5\u65B9\u6CD5","\u65B9\u6CD5"],\u5E38\u89C1\u8BEF\u533A:["\u5E38\u89C1\u8BEF\u533A","\u8BEF\u533A"],\u76F8\u5173\u77E5\u8BC6\u70B9:["\u76F8\u5173\u77E5\u8BC6\u70B9","\u5173\u8054"],\u539F\u6587\u51FA\u5904:["\u539F\u6587\u51FA\u5904","\u51FA\u5904"],\u542F\u793A:["\u542F\u793A","\u5BF9\u76EE\u6807\u4EBA\u7FA4\u7684\u542F\u793A"],\u66F4\u65B0\u65E5\u5FD7:["\u66F4\u65B0\u65E5\u5FD7","\u65E5\u5FD7"]}[e.section]||[e.section],c=-1,l="";for(let P of o){let _=new RegExp(`##\\s*[\\d\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u3001\\.]*\\s*${P.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}`),b=s.match(_);if(b){c=b.index,l=b[0];break}}if(c===-1){let P=new RegExp(`##\\s*[\\d\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u3001\\.]*\\s*${e.section.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}`),_=s.match(P);if(_)c=_.index,l=_[0];else return{success:!1,content:`\u672A\u627E\u5230\u7AE0\u8282\u300C${e.section}\u300D\u3002\u6587\u4EF6\u4E2D\u7684\u7AE0\u8282\u6807\u9898\u683C\u5F0F\u53EF\u80FD\u4E0D\u540C\uFF0C\u8BF7\u5148\u4F7F\u7528 read_vault_file \u8BFB\u53D6\u6587\u4EF6\u67E5\u770B\u5B9E\u9645\u7AE0\u8282\u540D\u79F0`}}let p=s.indexOf(`
## `,c+l.length),h=p===-1?s.length:p,m=s.substring(0,c),r=s.substring(h),d=s.substring(c,h),u=m+d+`

`+e.content+r,y=`| ${new Date().toISOString().split("T")[0]} | \u4FEE\u6539 | \u7528\u6237\u6307\u4EE4 | \u66F4\u65B0${e.section}\u7AE0\u8282 |`,g=/##\s*[一二三四五六七八九十、]*\s*更新日志/,k=u.match(g);if(k){let P=k.index,_=u.indexOf("| \u65E5\u671F |",P);if(_!==-1){let b=u.indexOf(`
`,_),x=u.indexOf(`
`,b+1);u=u.substring(0,x+1)+y+`
`+u.substring(x+1)}}return await this.app.vault.modify(n,u),{success:!0,content:`\u7AE0\u8282\u300C${e.section}\u300D\u5DF2\u66F4\u65B0: ${t}

\u8BF7\u6267\u884C\u81EA\u68C0\u6E05\u5355\u5E76\u66F4\u65B0\u96C6\u4E2D\u65E5\u5FD7\u3002`}}catch(t){return{success:!1,content:`\u66F4\u65B0\u77E5\u8BC6\u70B9\u9875\u9762\u5931\u8D25: ${t.message}`}}}}),this.tools.set("update_index",{name:"update_index",description:"\u66F4\u65B0\u77E5\u8BC6\u5E93\u7D22\u5F15\u6587\u4EF6\uFF08\u603B\u7D22\u5F15\u3001\u5173\u952E\u8BCD\u7D22\u5F15\u3001\u5173\u7CFB\u56FE\u8C31\uFF09",parameters:{type:"object",properties:{action:{type:"string",description:"\u66F4\u65B0\u7C7B\u578B",enum:["add_entry","refresh_all"]},entry_name:{type:"string",description:"\u6761\u76EE\u540D\u79F0"},entry_category:{type:"string",description:"\u6761\u76EE\u5206\u7C7B"},entry_description:{type:"string",description:"\u4E00\u53E5\u8BDD\u63CF\u8FF0"},entry_maturity:{type:"string",description:"\u6210\u719F\u5EA6",enum:["\u{1F7E2}","\u{1F7E1}","\u{1F534}"]},keywords:{type:"string",description:"\u65B0\u589E\u5173\u952E\u8BCD\uFF0C\u9017\u53F7\u5206\u9694"}},required:["action"]},execute:async e=>{try{let t=(0,a.normalizePath)(this.settings.knowledgeBasePath),n=`${t}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,s=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(n));if(!s||!(s instanceof a.TFile))return{success:!1,content:`\u7D22\u5F15\u6587\u4EF6\u4E0D\u5B58\u5728: ${n}`};if(e.action==="add_entry"&&e.entry_name&&e.entry_category){let i=await this.app.vault.read(s),o=e.entry_category,c=new RegExp(`###\\s+\\d+\\.\\s+${o.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}\\s*\\(\\d+\u4E2A\\)`),l=i.match(c);if(l){let p=i.indexOf(l[0]),h=i.indexOf(`
### `,p+1),m=h===-1?i.indexOf(`
---`,p):h,r=i.substring(p,m),d=r.match(/\((\d+)个\)/),u=d?parseInt(d[1]):0,f=u+1,y=r.replace(`(${u}\u4E2A)`,`(${f}\u4E2A)`).replace(/（暂无知识点）/,""),g=e.entry_maturity||"\u{1F7E1}",k=`- [[${e.entry_name}]] ${g} - ${e.entry_description||"\u5F85\u8865\u5145"}`,P=i.substring(0,p)+y.trimEnd()+`
`+k+`
`+i.substring(m);await this.app.vault.modify(s,P);let _=P.match(/知识点总数：(\d+)个/);if(_){let b=parseInt(_[1])+1,x=P.replace(`\u77E5\u8BC6\u70B9\u603B\u6570\uFF1A${_[1]}\u4E2A`,`\u77E5\u8BC6\u70B9\u603B\u6570\uFF1A${b}\u4E2A`);await this.app.vault.modify(s,x)}}if(e.keywords){let p=`${t}/20-\u77E5\u8BC6\u7D22\u5F15/\u5173\u952E\u8BCD\u7D22\u5F15.md`,h=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(p));if(h&&h instanceof a.TFile){let m=await this.app.vault.read(h),r=e.keywords.split(",").map(u=>`| ${u.trim()} | [[${e.entry_name}]] | 1 |`).join(`
`),d=m.replace("\uFF08\u6682\u65E0\u5173\u952E\u8BCD\uFF09",r);await this.app.vault.modify(h,d)}}return{success:!0,content:`\u7D22\u5F15\u5DF2\u66F4\u65B0\uFF1A\u6DFB\u52A0 ${e.entry_name} \u5230 ${e.entry_category}`}}return e.action==="refresh_all"?{success:!0,content:"\u8BF7\u4F7F\u7528 list_vault_folder \u5DE5\u5177\u626B\u63CF\u5404\u5206\u7C7B\u76EE\u5F55\uFF0C\u7136\u540E\u624B\u52A8\u66F4\u65B0\u7D22\u5F15\u6570\u91CF\u3002"}:{success:!0,content:"\u7D22\u5F15\u66F4\u65B0\u64CD\u4F5C\u5B8C\u6210"}}catch(t){return{success:!1,content:`\u66F4\u65B0\u7D22\u5F15\u5931\u8D25: ${t.message}`}}}}),this.tools.set("query_knowledge",{name:"query_knowledge",description:"\u67E5\u8BE2\u77E5\u8BC6\u5E93\uFF1A\u5148\u8BFB\u53D6\u7D22\u5F15\u4E86\u89E3\u7ED3\u6784\uFF0C\u518D\u8BFB\u53D6\u76F8\u5173\u77E5\u8BC6\u70B9\u9875\u9762",parameters:{type:"object",properties:{query:{type:"string",description:"\u67E5\u8BE2\u95EE\u9898\u6216\u5173\u952E\u8BCD"}},required:["query"]},execute:async e=>{try{let n=`${(0,a.normalizePath)(this.settings.knowledgeBasePath)}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,s=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(n));if(!s||!(s instanceof a.TFile))return{success:!1,content:`\u77E5\u8BC6\u5E93\u7D22\u5F15\u4E0D\u5B58\u5728\uFF0C\u8BF7\u5148\u521D\u59CB\u5316\u77E5\u8BC6\u5E93\u3002\u7D22\u5F15\u8DEF\u5F84: ${n}`};let i=await this.app.vault.read(s),o=e.query.toLowerCase(),c=i.split(`
`),l=[];for(let h of c)h.includes("[[")&&h.toLowerCase().includes(o.split(" ")[0])&&l.push(h.trim());let p=`\u77E5\u8BC6\u5E93\u7D22\u5F15\u6982\u89C8:
${i.substring(0,2e3)}

`;return l.length>0?p+=`\u4E0E "${e.query}" \u76F8\u5173\u7684\u6761\u76EE:
${l.join(`
`)}

`:p+=`\u5728\u7D22\u5F15\u4E2D\u672A\u627E\u5230\u4E0E "${e.query}" \u76F4\u63A5\u5339\u914D\u7684\u6761\u76EE\u3002

`,p+="\u8BF7\u6839\u636E\u4EE5\u4E0A\u7D22\u5F15\u4FE1\u606F\uFF0C\u4F7F\u7528 read_vault_file \u5DE5\u5177\u8BFB\u53D6\u76F8\u5173\u77E5\u8BC6\u70B9\u9875\u9762\u7684\u8BE6\u7EC6\u5185\u5BB9\u6765\u56DE\u7B54\u7528\u6237\u95EE\u9898\u3002",{success:!0,content:p}}catch(t){return{success:!1,content:`\u67E5\u8BE2\u77E5\u8BC6\u5E93\u5931\u8D25: ${t.message}`}}}}),this.tools.set("lint_knowledge_base",{name:"lint_knowledge_base",description:"\u5BF9\u77E5\u8BC6\u5E93\u6267\u884C\u6574\u7406\u68C0\u67E5\uFF1A\u68C0\u67E5\u77DB\u76FE\u3001\u5B64\u7ACB\u9875\u9762\u3001\u683C\u5F0F\u95EE\u9898\u7B49",parameters:{type:"object",properties:{check_type:{type:"string",description:"\u68C0\u67E5\u7C7B\u578B",enum:["full","format","content","links"]}},required:[]},execute:async e=>{try{let t=(0,a.normalizePath)(this.settings.knowledgeBasePath),n=e.check_type||"full",s=[],i=`${t}/10-\u77E5\u8BC6\u70B9\u5E93`,o=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(i));if(!o||!(o instanceof a.TFolder))return{success:!1,content:`\u77E5\u8BC6\u70B9\u5E93\u76EE\u5F55\u4E0D\u5B58\u5728: ${i}`};let c=[],l=[],p=new Set,h=r=>{for(let d of r.children)d instanceof a.TFile?(c.push(d),p.add(d.basename),d.stat.size===0&&l.push(d)):d instanceof a.TFolder&&h(d)};if(h(o),l.length>0&&s.push(`\u26A0\uFE0F \u53D1\u73B0 ${l.length} \u4E2A\u7A7A\u6587\u4EF6:
${l.map(r=>`  - ${r.path}`).join(`
`)}`),n==="full"||n==="links"){let r=[],d=new Set;for(let u of c.slice(0,50)){let y=(await this.app.vault.cachedRead(u)).matchAll(/\[\[([^\]]+)\]\]/g);for(let g of y)d.add(g[1].split("|")[0].split("#")[0].trim())}for(let u of p)d.has(u)||r.push(u);r.length>0&&s.push(`\u{1F517} \u53D1\u73B0 ${r.length} \u4E2A\u5B64\u7ACB\u9875\u9762\uFF08\u65E0\u5165\u94FE\uFF09:
${r.slice(0,20).map(u=>`  - ${u}`).join(`
`)}`)}if(n==="full"||n==="format")for(let r of c.slice(0,30)){let d=await this.app.vault.cachedRead(r);d.includes("## \u4E5D\u3001\u66F4\u65B0\u65E5\u5FD7")||s.push(`\u{1F4DD} ${r.basename} \u7F3A\u5C11"\u66F4\u65B0\u65E5\u5FD7"\u7AE0\u8282`),d.includes("## \u4E03\u3001\u539F\u6587\u51FA\u5904")||s.push(`\u{1F4DD} ${r.basename} \u7F3A\u5C11"\u539F\u6587\u51FA\u5904"\u7AE0\u8282`)}if(n==="full"||n==="content"){let r=`${t}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,d=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(r));if(d&&d instanceof a.TFile){let f=(await this.app.vault.read(d)).matchAll(/\((\d+)个\)/g);for(let y of f)parseInt(y[1])>0&&s.push(`\u{1F4CA} \u5206\u7C7B\u8BA1\u6570 ${y[0]} \u9700\u8981\u9A8C\u8BC1\u662F\u5426\u4E0E\u5B9E\u9645\u6587\u4EF6\u6570\u4E00\u81F4`)}}return{success:!0,content:s.length>0?`Lint \u68C0\u67E5\u5B8C\u6210\uFF0C\u53D1\u73B0 ${s.length} \u4E2A\u95EE\u9898:
...
\u8BF7\u4F7F\u7528 init_knowledge_base \u5DE5\u5177\u521D\u59CB\u5316\u77E5\u8BC6\u5E93\u3002`};let s={},i={"\u{1F7E2}":0,"\u{1F7E1}":0,"\u{1F534}":0},o=r=>{let d=0;for(let u of r.children)u instanceof a.TFile?d++:u instanceof a.TFolder&&(d+=o(u));return d};for(let r of n.children)r instanceof a.TFolder&&(s[r.name]=o(r));let c=`${t}/10-\u77E5\u8BC6\u70B9\u5E93`,l=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(c));if(l&&l instanceof a.TFolder){for(let r of l.children)if(r instanceof a.TFolder){for(let d of r.children)if(d instanceof a.TFile){let u=await this.app.vault.cachedRead(d);u.includes("\u{1F7E2}")?i["\u{1F7E2}"]++:u.includes("\u{1F7E1}")?i["\u{1F7E1}"]++:u.includes("\u{1F534}")&&i["\u{1F534}"]++}}}let p=`${t}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,h=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(p)),m="\u672A\u77E5";return h&&h instanceof a.TFile&&(m=new Date(h.stat.mtime).toLocaleString("zh-CN")),{success:!0,content:`\u{1F4CA} \u77E5\u8BC6\u5E93\u72B6\u6001\u62A5\u544A

\u8DEF\u5F84: ${t}
\u6700\u540E\u66F4\u65B0: ${m}

\u{1F4C1} \u76EE\u5F55\u7EDF\u8BA1:
${Object.entries(s).map(([r,d])=>`  - ${r}: ${d} \u4E2A\u6587\u4EF6`).join(`
`)}
...
\u2022 **'Lint'** - \u6267\u884C\u6574\u7406\u68C0\u67E5
\u2022 **'\u521B\u5EFA\u77E5\u8BC6\u70B9'** - \u65B0\u5EFA\u77E5\u8BC6\u70B9\u9875\u9762
\u2022 **'\u77E5\u8BC6\u5E93\u72B6\u6001'** - \u67E5\u770B\u77E5\u8BC6\u5E93\u6982\u51B5`))}async sendMessage(){let t=this.inputEl.value.trim();if(!(!t||this.isProcessing)){this.inputEl.value="",this.isProcessing=!0,this.sendBtn.addClass("llm-wiki-hidden"),this.stopBtn.removeClass("llm-wiki-hidden"),this.addUserMessage(t),this.addAssistantMessage("");try{let n=this.plugin.agentCore;if(!n){this.updateAssistantMessage("\u274C Agent \u672A\u521D\u59CB\u5316\uFF0C\u8BF7\u68C0\u67E5 API Key \u8BBE\u7F6E\u3002");return}let s=async i=>{this.finalizeAssistantMessage(),this.autoLog(t,i),await this.saveChatHistory()};this.plugin.settings.streamMode?await n.chatStream(t,{onToken:i=>this.appendToken(i),onToolCall:(i,o)=>this.showToolCall(i,o),onToolResult:(i,o)=>this.showToolResult(i,o),onComplete:i=>{s(i)},onError:i=>{this.updateAssistantMessage(`\u274C ${i}`),this.finalizeAssistantMessage()}}):await n.chatNonStream(t,{onToken:i=>this.appendToken(i),onToolCall:(i,o)=>this.showToolCall(i,o),onToolResult:(i,o)=>this.showToolResult(i,o),onComplete:i=>{s(i)},onError:i=>{this.updateAssistantMessage(`\u274C ${i}`),this.finalizeAssistantMessage()}})}catch(n){this.updateAssistantMessage(`\u274C \u53D1\u751F\u9519\u8BEF: ${n instanceof Error?n.message:String(n)}`)}finally{this.isProcessing=!1,this.sendBtn.removeClass("llm-wiki-hidden"),this.stopBtn.addClass("llm-wiki-hidden"),this.toolCardEl=null,this.inputEl.focus()}}}stopGeneration(){var t;(t=this.plugin.agentCore)==null||t.abort(),this.isProcessing=!1,this.sendBtn.removeClass("llm-wiki-hidden"),this.stopBtn.addClass("llm-wiki-hidden")}async addUserMessage(t){let n=this.messagesEl.createEl("div",{cls:"llm-wiki-message llm-wiki-user-message"});n.createEl("div",{cls:"llm-wiki-message-sender",text:"\u4F60"});let s=n.createEl("div",{cls:"llm-wiki-message-content"});await C.MarkdownRenderer.render(this.app,t,s,"",this),this.scrollToBottom()}addSystemMessage(t){let s=this.messagesEl.createEl("div",{cls:"llm-wiki-message llm-wiki-system-message"}).createEl("div",{cls:"llm-wiki-message-content"});C.MarkdownRenderer.render(this.app,t,s,"",this)}addAssistantMessage(t){let n=this.messagesEl.createEl("div",{cls:"llm-wiki-message llm-wiki-assistant-message"});n.createEl("div",{cls:"llm-wiki-message-sender",text:"Agent"}),this.currentAssistantEl=n.createEl("div",{cls:"llm-wiki-message-content"}),this.currentContent=t,this.tokenBuffer=""}updateAssistantMessage(t){this.currentAssistantEl&&(this.currentContent=t,this.currentAssistantEl.empty(),C.MarkdownRenderer.render(this.app,t,this.currentAssistantEl,"",this),this.scrollToBottom())}appendToken(t){this.currentContent+=t,this.tokenBuffer+=t,this.renderTimer||(this.renderTimer=window.setInterval(()=>this.flushTokenBuffer(),50)),this.scrollToBottom()}flushTokenBuffer(){this.renderTimer&&(window.clearInterval(this.renderTimer),this.renderTimer=null),this.tokenBuffer&&this.currentAssistantEl&&(this.currentAssistantEl.empty(),C.MarkdownRenderer.render(this.app,this.currentContent,this.currentAssistantEl,"",this),this.tokenBuffer="")}finalizeAssistantMessage(){this.flushTokenBuffer(),this.currentAssistantEl=null,this.currentContent=""}showToolCall(t,n){let s=JSON.stringify(n,null,2);if(this.currentAssistantEl){let i=this.currentAssistantEl.createEl("div",{cls:"llm-wiki-tool-card llm-wiki-tool-running"});i.createEl("div",{cls:"llm-wiki-tool-name",text:`\u{1F7E1} \u8C03\u7528\u5DE5\u5177: ${t}`});let o=i.createEl("pre",{cls:"llm-wiki-tool-args"});o.textContent=s,this.toolCardEl=i}this.scrollToBottom()}showToolResult(t,n){if(this.toolCardEl){let s=n.success?`\u{1F7E2} ${t} \u5B8C\u6210`:`\u{1F534} ${t} \u5931\u8D25`,i=this.toolCardEl.querySelector(".llm-wiki-tool-name");if(i&&(i.textContent=s),this.toolCardEl.removeClass("llm-wiki-tool-running"),this.toolCardEl.addClass(n.success?"llm-wiki-tool-success":"llm-wiki-tool-error"),n.content){let o=this.toolCardEl.createEl("div",{cls:"llm-wiki-tool-result"});o.textContent=n.content.length>300?n.content.substring(0,300)+"...":n.content}this.toolCardEl=null}this.scrollToBottom()}scrollToBottom(){this.messagesEl.scrollTop=this.messagesEl.scrollHeight}async autoLog(t,n){if(!(!this.plugin.settings.autoLog||!this.plugin.memoryService))try{let s=t.length>50?t.substring(0,50)+"...":t,i=n.length>200?n.substring(0,200)+"...":n;await this.plugin.memoryService.writeLog(s,`\u7528\u6237: ${t}`,i)}catch(s){}}async saveChatHistory(){var t;try{let n=(t=this.plugin.agentCore)==null?void 0:t.getHistory();if(!n||n.length===0)return;let s={messages:n,savedAt:new Date().toISOString()},i=(0,C.normalizePath)(`${this.plugin.settings.memoryFolder}/\u5BF9\u8BDD\u5386\u53F2.json`),o=this.app.vault.getAbstractFileByPath(i);o&&o instanceof C.TFile?await this.app.vault.modify(o,JSON.stringify(s,null,2)):await this.app.vault.create(i,JSON.stringify(s,null,2))}catch(n){}}async loadChatHistory(){var t;try{let n=(0,C.normalizePath)(`${this.plugin.settings.memoryFolder}/\u5BF9\u8BDD\u5386\u53F2.json`),s=this.app.vault.getAbstractFileByPath(n);if(!s||!(s instanceof C.TFile)){this.addSystemMessage(`\u6B22\u8FCE\u4F7F\u7528 LLM Wiki \u77E5\u8BC6\u5E93\u52A9\u624B\uFF01

\u8BF7\u5148\u5B8C\u6210\u4EE5\u4E0B\u8BBE\u7F6E\uFF1A
1. \u5728\u8BBE\u7F6E\u4E2D\u586B\u5199 API Key\uFF08\u652F\u6301 OpenAI / DeepSeek / \u7845\u57FA\u6D41\u52A8\u7B49\uFF09
2. \u8BBE\u7F6E\u77E5\u8BC6\u5E93\u8DEF\u5F84

\u7136\u540E\u5C31\u53EF\u4EE5\u5F00\u59CB\u5BF9\u8BDD\u4E86\uFF01`);return}let i=await this.app.vault.read(s),o=JSON.parse(i);(t=this.plugin.agentCore)==null||t.setHistory(o.messages||[]);for(let c of o.messages||[])c.role==="user"?this.addUserMessage(c.content):c.role==="assistant"&&!c.tool_calls&&(this.addAssistantMessage(c.content),this.finalizeAssistantMessage())}catch(n){this.addSystemMessage("\u6B22\u8FCE\u56DE\u6765\uFF01\u4E0A\u6B21\u7684\u5BF9\u8BDD\u5386\u53F2\u52A0\u8F7D\u5931\u8D25\uFF0C\u5DF2\u5F00\u542F\u65B0\u5BF9\u8BDD\u3002")}}};var v=require("obsidian"),O=class{constructor(e,t){this.app=e,this.settings=t}updateSettings(e){this.settings=e}async loadSkillContent(){try{let e=(0,v.normalizePath)(`${this.settings.skillFolderPath}/SKILL.md`),t=this.app.vault.getAbstractFileByPath(e);if(t&&t instanceof v.TFile)return await this.app.vault.read(t)}catch(e){}return""}async loadReferencesContent(){try{let e=[],t=(0,v.normalizePath)(`${this.settings.skillFolderPath}/references`),n=this.app.vault.getAbstractFileByPath(t);if(n&&n instanceof v.TFolder){for(let s of n.children)if(s instanceof v.TFile&&s.extension==="md"){let i=await this.app.vault.read(s);e.push(`### ${s.name}

${i}`)}}return e.join(`

---

`)}catch(e){}return""}async loadMemoryContext(){let e=[],t=(0,v.normalizePath)(`${this.settings.memoryFolder}/\u957F\u671F\u8BB0\u5FC6.md`),n=this.app.vault.getAbstractFileByPath(t);n&&n instanceof v.TFile&&e.push(await this.app.vault.read(n));let s=(0,v.normalizePath)(`${this.settings.memoryFolder}/\u7528\u6237\u504F\u597D.md`),i=this.app.vault.getAbstractFileByPath(s);return i&&i instanceof v.TFile&&e.push(await this.app.vault.read(i)),e.join(`

---

`)}async writeLog(e,t,n){let s=new Date().toISOString().split("T")[0],i=(0,v.normalizePath)(`${this.settings.memoryFolder}/\u65E5\u5FD7/${s}.md`),o=`## ${new Date().toLocaleTimeString("zh-CN",{hour:"2-digit",minute:"2-digit"})} | ${e}
...
---
`,c=this.app.vault.getAbstractFileByPath(i);if(c&&c instanceof v.TFile){let l=await this.app.vault.read(c);await this.app.vault.modify(c,l+o)}else await this.ensureFolder(`${this.settings.memoryFolder}/\u65E5\u5FD7`),await this.app.vault.create(i,`# \u5DE5\u4F5C\u65E5\u5FD7 ${s}

${o}`)}async ensureFolder(e){if(!e)return;let t=(0,v.normalizePath)(e).split("/"),n="";for(let s of t)n=n?`${n}/${s}`:s,this.app.vault.getAbstractFileByPath(n)||await this.app.vault.createFolder(n)}};var I=class{constructor(){this.summaryCache=new Map;this.maxTokens=8e3}setMaxTokens(e){this.maxTokens=e}estimateTokens(e){return Math.ceil(e.length/2)}async compressHistory(e,t){let n=e.map(r=>r.content||"").join(`
...
`),p=this.hashText(l),h=this.summaryCache.get(p);if(!h)try{h=await t([{role:"system",content:"\u5C06\u4EE5\u4E0B\u5BF9\u8BDD\u5386\u53F2\u538B\u7F29\u4E3A\u4E00\u6BB5\u7B80\u6D01\u7684\u6458\u8981\uFF0C\u4FDD\u7559\u5173\u952E\u4FE1\u606F\u3001\u51B3\u7B56\u548C\u7ED3\u8BBA\uFF0C\u4E0D\u8D85\u8FC7500\u5B57\u3002\u5982\u679C\u6D89\u53CA\u77E5\u8BC6\u70B9\u5E93\u7684\u64CD\u4F5C\uFF0C\u4FDD\u7559\u6587\u4EF6\u8DEF\u5F84\u548C\u64CD\u4F5C\u7C7B\u578B\u3002"},{role:"user",content:l}]),this.summaryCache.set(p,h)}catch(r){h=`[\u65E9\u671F\u5BF9\u8BDD\u6458\u8981: ${l.substring(0,500)}...]`}return[{role:"assistant",content:`[\u5386\u53F2\u5BF9\u8BDD\u6458\u8981]
...
`);return{originalTokens:this.estimateTokens(t),compressedTokens:Math.ceil(t.length/3),turns:e.filter(n=>n.role==="user").length}}};var j=class extends R.Plugin{async onload(){await this.loadSettings(),this.addSettingTab(new E(this.app,this)),this.toolRegistry=new A(this.app,this.settings),this.memoryService=new O(this.app,this.settings),this.contextManager=new I,await this.initAgent(),this.registerView(S,t=>new B(t,this)),this.addCommand({id:"open-llm-wiki-chat",name:"\u6253\u5F00 LLM Wiki \u77E5\u8BC6\u5E93\u52A9\u624B",callback:()=>this.activateChatView()}),this.addRibbonIcon("message-square","LLM Wiki \u77E5\u8BC6\u5E93\u52A9\u624B",()=>{this.activateChatView()}),this.applyTheme(),this.app.workspace.onLayoutReady(()=>{this.activateChatView()})}onunload(){}async initAgent(){let[t,n,s]=await Promise.all([this.memoryService.loadSkillContent(),this.memoryService.loadReferencesContent(),this.memoryService.loadMemoryContext()]);this.agentCore=new M(this.settings,this.toolRegistry),this.agentCore.init(t,n,s)}async activateChatView(){let{workspace:t}=this.app,n=t.getLeavesOfType(S)[0];if(!n){let s=t.getRightLeaf(!1);s&&(await s.setViewState({type:S,active:!0}),n=t.getLeavesOfType(S)[0])}n&&t.revealLeaf(n)}applyTheme(){try{let t=this.app.workspace.getActiveViewOfType(R.ItemView),n=t?t.containerEl.ownerDocument:window.document;n.body.classList.remove("llm-wiki-theme-dark-blue","llm-wiki-theme-warm-light","llm-wiki-theme-obsidian-red","llm-wiki-theme-lavender","llm-wiki-theme-forest-green"),n.body.classList.add(`llm-wiki-theme-${this.settings.theme}`)}catch(t){window.document.body.classList.remove("llm-wiki-theme-dark-blue","llm-wiki-theme-warm-light","llm-wiki-theme-obsidian-red","llm-wiki-theme-lavender","llm-wiki-theme-forest-green"),window.document.body.classList.add(`llm-wiki-theme-${this.settings.theme}`)}}async loadSettings(){this.settings=Object.assign({},z,await this.loadData())}async saveSettings(){await this.saveData(this.settings),await this.initAgent(),this.memoryService.updateSettings(this.settings)}};
