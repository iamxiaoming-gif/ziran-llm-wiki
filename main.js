var V=Object.defineProperty;var G=Object.getOwnPropertyDescriptor;var Y=Object.getOwnPropertyNames;var Q=Object.prototype.hasOwnProperty;var X=($,e)=>{for(var t in e)V($,t,{get:e[t],enumerable:!0})},Z=($,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Y(e))!Q.call($,s)&&s!==t&&V($,s,{get:()=>e[s],enumerable:!(n=G(e,s))||n.enumerable});return $};var tt=$=>Z(V({},"__esModule",{value:!0}),$);var nt={};X(nt,{default:()=>q});module.exports=tt(nt);var U=require("obsidian");var x=require("obsidian"),z={apiKey:"",apiBaseUrl:"https://api.openai.com/v1",modelName:"gpt-4o",knowledgeBasePath:"\u77E5\u8BC6\u5E93",memoryFolder:"\u8BB0\u5FC6",skillFolderPath:"\u77E5\u8BC6\u5E93",theme:"dark-blue",temperature:.7,maxIterations:15,autoLog:!0,streamMode:!0};function et($,e){let t=null;return(...n)=>{t&&clearTimeout(t),t=setTimeout(()=>$(...n),e)}}var B=class extends x.PluginSettingTab{constructor(t,n){super(t,n);this.plugin=n,this.debouncedSave=et(async()=>{await this.plugin.saveSettings()},500)}display(){let{containerEl:t}=this;t.empty(),t.createEl("h2",{text:"LLM Wiki \u77E5\u8BC6\u5E93\u52A9\u624B\u8BBE\u7F6E"}),new x.Setting(t).setName("API Key").setDesc("OpenAI \u517C\u5BB9 API \u5BC6\u94A5").addText(n=>{n.setPlaceholder("sk-...").setValue(this.plugin.settings.apiKey).onChange(async i=>{this.plugin.settings.apiKey=i,this.debouncedSave()});let s=n.inputEl;s.type="password"}),new x.Setting(t).setName("API Base URL").setDesc("OpenAI \u517C\u5BB9 API \u5730\u5740").addText(n=>n.setPlaceholder("https://api.openai.com/v1").setValue(this.plugin.settings.apiBaseUrl).onChange(async s=>{this.plugin.settings.apiBaseUrl=s,this.debouncedSave()})),new x.Setting(t).setName("\u6A21\u578B\u540D\u79F0").setDesc("\u4F7F\u7528\u7684\u6A21\u578B\uFF0C\u5982 gpt-4o\u3001deepseek-chat \u7B49").addText(n=>n.setPlaceholder("gpt-4o").setValue(this.plugin.settings.modelName).onChange(async s=>{this.plugin.settings.modelName=s,this.debouncedSave()})),new x.Setting(t).setName("\u77E5\u8BC6\u5E93\u8DEF\u5F84").setDesc("\u77E5\u8BC6\u5E93\u5728 Vault \u4E2D\u7684\u6839\u8DEF\u5F84").addText(n=>n.setPlaceholder("\u77E5\u8BC6\u5E93").setValue(this.plugin.settings.knowledgeBasePath).onChange(async s=>{this.plugin.settings.knowledgeBasePath=s,this.debouncedSave()})),new x.Setting(t).setName("Skill \u6587\u4EF6\u5939\u8DEF\u5F84").setDesc("\u5305\u542B SKILL.md \u548C references/ \u5B50\u6587\u4EF6\u5939\u7684\u76EE\u5F55\u8DEF\u5F84\uFF08\u4ECE vault \u6839\u76EE\u5F55\u5F00\u59CB\uFF09").addText(n=>n.setPlaceholder("\u77E5\u8BC6\u5E93").setValue(this.plugin.settings.skillFolderPath).onChange(async s=>{this.plugin.settings.skillFolderPath=s,this.debouncedSave()})),new x.Setting(t).setName("\u8BB0\u5FC6\u6587\u4EF6\u5939\u8DEF\u5F84").setDesc("Agent \u8BB0\u5FC6\u5B58\u50A8\u8DEF\u5F84").addText(n=>n.setPlaceholder("\u8BB0\u5FC6").setValue(this.plugin.settings.memoryFolder).onChange(async s=>{this.plugin.settings.memoryFolder=s,this.debouncedSave()})),new x.Setting(t).setName("\u4E3B\u9898").setDesc("\u754C\u9762\u4E3B\u9898\u98CE\u683C").addDropdown(n=>n.addOptions({"dark-blue":"\u6697\u591C\u84DD","warm-light":"\u6696\u767D","obsidian-red":"Obsidian \u7EA2",lavender:"\u85B0\u8863\u8349\u7D2B","forest-green":"\u58A8\u7EFF"}).setValue(this.plugin.settings.theme).onChange(async s=>{this.plugin.settings.theme=s,await this.plugin.saveSettings(),this.plugin.applyTheme()})),new x.Setting(t).setName("Temperature").setDesc("LLM \u751F\u6210\u6E29\u5EA6 (0-2)").addSlider(n=>n.setLimits(0,2,.1).setValue(this.plugin.settings.temperature).setDynamicTooltip().onChange(async s=>{this.plugin.settings.temperature=s,this.debouncedSave()})),new x.Setting(t).setName("\u6700\u5927\u8FED\u4EE3\u6B21\u6570").setDesc("Agent \u5DE5\u5177\u8C03\u7528\u6700\u5927\u8FED\u4EE3\u6B21\u6570").addSlider(n=>n.setLimits(1,30,1).setValue(this.plugin.settings.maxIterations).setDynamicTooltip().onChange(async s=>{this.plugin.settings.maxIterations=s,this.debouncedSave()})),new x.Setting(t).setName("\u6D41\u5F0F\u8F93\u51FA").setDesc("\u542F\u7528\u6D41\u5F0F\u8F93\u51FA\uFF08\u5B9E\u65F6\u663E\u793A\u56DE\u590D\uFF09").addToggle(n=>n.setValue(this.plugin.settings.streamMode).onChange(async s=>{this.plugin.settings.streamMode=s,await this.plugin.saveSettings()})),new x.Setting(t).setName("\u81EA\u52A8\u65E5\u5FD7").setDesc("\u5BF9\u8BDD\u5B8C\u6210\u540E\u81EA\u52A8\u8BB0\u5F55\u5DE5\u4F5C\u65E5\u5FD7").addToggle(n=>n.setValue(this.plugin.settings.autoLog).onChange(async s=>{this.plugin.settings.autoLog=s,await this.plugin.saveSettings()}))}};var K=require("obsidian");function H($,e,t,n=""){let s=[],i=`\u4F60\u662F\u4E00\u4E2A\u77E5\u8BC6\u5E93\u6784\u5EFA\u4E0E\u7EF4\u62A4\u52A9\u624B\u3002\u4F60\u7684\u5DE5\u4F5C\u89C4\u8303\u3001\u539F\u5219\u3001\u5DE5\u4F5C\u6D41\u3001\u8D28\u91CF\u63A7\u5236\u6807\u51C6\u3001\u9875\u9762\u6A21\u677F\u7B49\u5168\u90E8\u5B9A\u4E49\u5728\u4E0B\u65B9\u300C\u77E5\u8BC6\u5E93\u6784\u5EFA\u89C4\u8303\u300D\u4E2D\u3002
...
`)}var O=class{constructor(e,t){this.history=[];this.abortController=null;this.systemPrompt="";this.settings=e,this.toolRegistry=t}init(e="",t="",n=""){this.systemPrompt=H(this.settings,e,t,n),this.history=[]}setHistory(e){this.history=e}getHistory(){return this.history}clearHistory(){this.history=[]}updateSettings(e){this.settings=e,this.toolRegistry.updateSettings(e)}abort(){this.abortController&&(this.abortController.abort(),this.abortController=null)}async chatStream(e,t){this.history.push({role:"user",content:e});let n="",s=0,i=this.settings.maxIterations||15;for(;s<i;){s++;let c=[{role:"system",content:this.systemPrompt},...this.history];try{let p=await this.streamCompletion(c,t);if(n=p.content,p.toolCalls.length===0){this.history.push({role:"assistant",content:p.content}),t.onComplete(n);return}this.history.push({role:"assistant",content:p.content||"",tool_calls:p.toolCalls});for(let u of p.toolCalls){let h={};try{h=JSON.parse(u.function.arguments)}catch(r){h={}}t.onToolCall(u.function.name,h);let m=await this.toolRegistry.executeTool(u.function.name,h);t.onToolResult(u.function.name,m),this.history.push({role:"tool",content:m.content,tool_call_id:u.id,name:u.function.name})}}catch(p){if(p.name==="AbortError"){t.onComplete(n);return}let u=`\u8BF7\u6C42\u5931\u8D25: ${p.message}`;this.history.push({role:"assistant",content:u}),t.onError(u);return}}let o=`\u5DF2\u8FBE\u5230\u6700\u5927\u8FED\u4EE3\u6B21\u6570(${i})\uFF0C\u8BF7\u7B80\u5316\u95EE\u9898\u6216\u5206\u6B65\u6267\u884C\u3002`;this.history.push({role:"assistant",content:o}),t.onComplete(o)}async streamCompletion(e,t){var r,l,d,f,y,g,_;let n=`${this.settings.apiBaseUrl}/chat/completions`,s={model:this.settings.modelName,messages:e.map(w=>({role:w.role,content:w.content||null,tool_calls:w.tool_calls,tool_call_id:w.tool_call_id,name:w.name})),tools:this.toolRegistry.getToolDefinitions(),tool_choice:"auto",temperature:this.settings.temperature,stream:!0};this.abortController=new AbortController;let i=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.settings.apiKey}`},body:JSON.stringify(s),signal:(r=this.abortController)==null?void 0:r.signal});if(!i.ok){let w=await i.text().catch(()=>"\u672A\u77E5\u9519\u8BEF");throw new Error(`API \u8BF7\u6C42\u5931\u8D25: ${i.status} ${w}`)}let o=(l=i.body)==null?void 0:l.getReader();if(!o)throw new Error("\u65E0\u6CD5\u83B7\u53D6\u54CD\u5E94\u6D41");let c=new TextDecoder,p="",u="",h=new Map;for(;;){let{done:w,value:v}=await o.read();if(w)break;p+=c.decode(v,{stream:!0});let k=p.split(`
`);p=k.pop()||"";for(let C of k){let L=C.trim();if(!(!L||L==="data: [DONE]")&&L.startsWith("data: "))try{let T=(f=(d=JSON.parse(L.slice(6)).choices)==null?void 0:d[0])==null?void 0:f.delta;if(!T)continue;if(T.content&&(u+=T.content,t.onToken(T.content)),T.tool_calls)for(let S of T.tool_calls){let A=(y=S.index)!=null?y:0;h.has(A)||h.set(A,{id:"",type:"function",function:{name:"",arguments:""}});let E=h.get(A);S.id&&(E.id+=S.id),(g=S.function)!=null&&g.name&&(E.function.name+=S.function.name),(_=S.function)!=null&&_.arguments&&(E.function.arguments+=S.function.arguments)}}catch(M){continue}}}let m=Array.from(h.values()).filter(w=>w.id);return this.abortController=null,{content:u,toolCalls:m}}async chatNonStream(e,t){this.history.push({role:"user",content:e});let n="",s=0,i=this.settings.maxIterations||15;for(;s<i;){s++;let c=[{role:"system",content:this.systemPrompt},...this.history];try{let p=await this.nonStreamCompletion(c),u=p.content;if(p.toolCalls.length===0){t.onToken(u),this.history.push({role:"assistant",content:u}),n=u,t.onComplete(n);return}this.history.push({role:"assistant",content:u||"",tool_calls:p.toolCalls});for(let h of p.toolCalls){let m={};try{m=JSON.parse(h.function.arguments)}catch(l){m={}}t.onToolCall(h.function.name,m);let r=await this.toolRegistry.executeTool(h.function.name,m);t.onToolResult(h.function.name,r),this.history.push({role:"tool",content:r.content,tool_call_id:h.id,name:h.function.name})}}catch(p){let u=`\u8BF7\u6C42\u5931\u8D25: ${p.message}`;this.history.push({role:"assistant",content:u}),t.onError(u);return}}let o=`\u5DF2\u8FBE\u5230\u6700\u5927\u8FED\u4EE3\u6B21\u6570(${i})`;this.history.push({role:"assistant",content:o}),t.onComplete(o)}async nonStreamCompletion(e){var i;let t=`${this.settings.apiBaseUrl}/chat/completions`,n={model:this.settings.modelName,messages:e.map(o=>({role:o.role,content:o.content||null,tool_calls:o.tool_calls,tool_call_id:o.tool_call_id,name:o.name})),tools:this.toolRegistry.getToolDefinitions(),tool_choice:"auto",temperature:this.settings.temperature,stream:!1},s=2;for(let o=0;o<=s;o++)try{let p=(i=(await(0,K.requestUrl)({url:t,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.settings.apiKey}`},body:JSON.stringify(n)})).json.choices)==null?void 0:i[0];if(!p)throw new Error("API \u8FD4\u56DE\u4E3A\u7A7A");let u=p.message||{};return{content:u.content||"",toolCalls:u.tool_calls||[]}}catch(c){let p=(c==null?void 0:c.status)||0;if(p>=400&&p<500)throw c;if(o<s)await new Promise(u=>setTimeout(u,1e3*(o+1)));else throw c}throw new Error("API \u8C03\u7528\u5931\u8D25\uFF08\u5DF2\u91CD\u8BD5\uFF09")}};var a=require("obsidian"),I=class{constructor(e,t){this.tools=new Map;this.app=e,this.settings=t,this.registerAllTools()}updateSettings(e){this.settings=e}registerAllTools(){this.registerVaultTools(),this.registerSkillTools(),this.registerMemoryTools()}registerVaultTools(){this.tools.set("read_vault_file",{name:"read_vault_file",description:"\u8BFB\u53D6 Vault \u4E2D\u7684\u6587\u4EF6\u5185\u5BB9",parameters:{type:"object",properties:{path:{type:"string",description:"\u6587\u4EF6\u5728 Vault \u4E2D\u7684\u76F8\u5BF9\u8DEF\u5F84"}},required:["path"]},execute:async e=>{try{let t=(0,a.normalizePath)(e.path),n=this.app.vault.getAbstractFileByPath(t);return!n||!(n instanceof a.TFile)?{success:!1,content:`\u6587\u4EF6\u4E0D\u5B58\u5728: ${t}`}:{success:!0,content:await this.app.vault.read(n)}}catch(t){return{success:!1,content:`\u8BFB\u53D6\u6587\u4EF6\u5931\u8D25: ${t.message}`}}}}),this.tools.set("write_vault_file",{name:"write_vault_file",description:"\u521B\u5EFA\u65B0\u6587\u4EF6\uFF08\u4E0D\u80FD\u5199\u5165 00-\u539F\u59CB\u8D44\u6599/ \u76EE\u5F55\u3002\u5982\u679C\u6587\u4EF6\u5DF2\u5B58\u5728\u5219\u62A5\u9519\uFF09",parameters:{type:"object",properties:{path:{type:"string",description:"\u6587\u4EF6\u5728 Vault \u4E2D\u7684\u76F8\u5BF9\u8DEF\u5F84\uFF08\u5FC5\u987B\u662F\u4E0D\u5B58\u5728\u7684\u8DEF\u5F84\uFF0C\u4E14\u4E0D\u80FD\u5728 00-\u539F\u59CB\u8D44\u6599/ \u4E0B\uFF09"},content:{type:"string",description:"\u6587\u4EF6\u5185\u5BB9"}},required:["path","content"]},execute:async e=>{try{let t=(0,a.normalizePath)(e.path),n=this.isUnderRawMaterials(t);if(n)return{success:!1,content:`\u7981\u6B62\u5199\u5165\u539F\u59CB\u8D44\u6599\u76EE\u5F55\uFF1A${n}\u300200-\u539F\u59CB\u8D44\u6599/ \u76EE\u5F55\u53EA\u8BFB\uFF0C\u4E0D\u80FD\u4FEE\u6539\u3002\u5982\u679C\u7528\u6237\u9700\u8981\u79FB\u52A8\u6587\u4EF6\uFF0C\u8BF7\u544A\u77E5\u7528\u6237\u624B\u52A8\u64CD\u4F5C\u3002`};let s=this.app.vault.getAbstractFileByPath(t);return s&&s instanceof a.TFile?{success:!1,content:`\u6587\u4EF6\u5DF2\u5B58\u5728\uFF0C\u7981\u6B62\u8986\u76D6\uFF1A${t}\u3002\u8BF7\u4F7F\u7528 append_vault_file \u8FFD\u52A0\u5185\u5BB9\uFF0C\u6216\u4F7F\u7528 update_knowledge_page \u66F4\u65B0\u9875\u9762\u7AE0\u8282\u3002`}:(await this.ensureFolder(t.substring(0,t.lastIndexOf("/"))),await this.app.vault.create(t,e.content),{success:!0,content:`\u6587\u4EF6\u5DF2\u521B\u5EFA: ${t}`})}catch(t){return{success:!1,content:`\u521B\u5EFA\u6587\u4EF6\u5931\u8D25: ${t.message}`}}}}),this.tools.set("append_vault_file",{name:"append_vault_file",description:"\u5728 Vault \u6587\u4EF6\u672B\u5C3E\u8FFD\u52A0\u5185\u5BB9\uFF08\u4E0D\u80FD\u4FEE\u6539 00-\u539F\u59CB\u8D44\u6599/ \u76EE\u5F55\u4E0B\u7684\u6587\u4EF6\uFF09",parameters:{type:"object",properties:{path:{type:"string",description:"\u6587\u4EF6\u5728 Vault \u4E2D\u7684\u76F8\u5BF9\u8DEF\u5F84"},content:{type:"string",description:"\u8981\u8FFD\u52A0\u7684\u5185\u5BB9"}},required:["path","content"]},execute:async e=>{try{let t=(0,a.normalizePath)(e.path),n=this.isUnderRawMaterials(t);if(n)return{success:!1,content:`\u7981\u6B62\u4FEE\u6539\u539F\u59CB\u8D44\u6599\u76EE\u5F55\uFF1A${n}\u300200-\u539F\u59CB\u8D44\u6599/ \u76EE\u5F55\u53EA\u8BFB\u3002`};let s=this.app.vault.getAbstractFileByPath(t);if(!s||!(s instanceof a.TFile))return{success:!1,content:`\u6587\u4EF6\u4E0D\u5B58\u5728: ${t}`};let i=await this.app.vault.read(s);return await this.app.vault.modify(s,i+`
...
${n.map((r,l)=>`### ${l+1}. ${r.trim()}\uFF080\u4E2A\uFF09\u{1F534}
...
\uFF08\u6682\u65E0\u5173\u952E\u8BCD\uFF09
`;await this.createFileOnly(`${t}/20-\u77E5\u8BC6\u7D22\u5F15/\u5173\u952E\u8BCD\u7D22\u5F15.md`,c);let p=`# ${e.topic_name}\u77E5\u8BC6\u70B9\u5173\u7CFB\u56FE\u8C31
...
\uFF08\u6682\u65E0\u5173\u7CFB\u6570\u636E\uFF09
`;await this.createFileOnly(`${t}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u70B9\u5173\u7CFB\u56FE\u8C31.md`,p);let u=`# \u77E5\u8BC6\u5E93\u66F4\u65B0\u65E5\u5FD7
...
---
`;await this.createFileOnly(`${t}/30-\u7EF4\u62A4\u8BB0\u5F55/\u77E5\u8BC6\u5E93\u66F4\u65B0\u65E5\u5FD7.md`,u);let h=`# \u51B2\u7A81\u4E0E\u9519\u8BEF\u8BB0\u5F55

\uFF08\u6682\u65E0\u51B2\u7A81\u8BB0\u5F55\uFF09
`;await this.createFileOnly(`${t}/30-\u7EF4\u62A4\u8BB0\u5F55/\u51B2\u7A81\u4E0E\u9519\u8BEF\u8BB0\u5F55.md`,h);let m=`# AGENTS.md \u2014 ${e.topic_name}\u77E5\u8BC6\u5E93\u7EF4\u62A4\u89C4\u5219
...
\u2514\u2500\u2500 AGENTS.md
\`\`\`
`;try{let r=(0,a.normalizePath)(`${this.settings.skillFolderPath}/references/AGENTS-template.md`),l=this.app.vault.getAbstractFileByPath(r);l&&l instanceof a.TFile&&(m=(await this.app.vault.read(l)).replace(/\[专题名称\]/g,e.topic_name).replace(/\[专题名称\]/g,e.topic_name).replace(/YYYY-MM-DD/g,new Date().toISOString().split("T")[0]).replace(/\[方括号\]/g,""))}catch(r){}return await this.createFileOnly(`${t}/AGENTS.md`,m),{success:!0,content:`\u77E5\u8BC6\u5E93 "${e.topic_name}" \u5DF2\u521D\u59CB\u5316\u5B8C\u6210\uFF01
...
\u6216\u8005\u76F4\u63A5\u4F7F\u7528 create_and_index_page \u4E00\u7AD9\u5F0F\u5B8C\u6210\u4E0A\u8FF0\u5168\u90E8\u6B65\u9AA4\u3002`};let c=e.maturity?`${e.maturity}`:"\u57FA\u7840\u7EA7",p=c.includes("\u5B8C\u6574")?"\u{1F7E2}":c.includes("\u6846\u67B6")?"\u{1F534}":"\u{1F7E1}",u=`### \u8981\u70B91\uFF1A[\u5F85\u8865\u5145]

[\u5F85\u8865\u5145]`;if(e.key_points)try{u=JSON.parse(e.key_points).map((g,_)=>`### \u8981\u70B9${_+1}\uFF1A${g.name||g.title}

${g.content||g.description||""}`).join(`

`)}catch(y){u=e.key_points}let h=`### \u6848\u4F8B1\uFF1A[\u5F85\u8865\u5145]

[\u5F85\u8865\u5145]`;if(e.cases)try{h=JSON.parse(e.cases).map((g,_)=>`### \u6848\u4F8B${_+1}\uFF1A${g.name||g.title}

${g.content||g.description||""}`).join(`

`)}catch(y){h=e.cases}let m=`### \u65B9\u6CD51\uFF1A[\u5F85\u8865\u5145]
...
`)}catch(y){r=e.misconceptions}let l=(e.related_topics||"").split(",").filter(y=>y.trim()).map(y=>`- [[${y.trim()}]]`).join(`
`),d=(e.source_refs||"").split(",").filter(y=>y.trim()).map(y=>`- [[${y.trim()}]]`).join(`
`),f=`# ${e.title}
...
\u63A8\u8350\u76F4\u63A5\u4F7F\u7528 create_and_index_page \u4E00\u7AD9\u5F0F\u5B8C\u6210\u4EE5\u4E0A\u6B65\u9AA4\u3002`}}catch(t){return{success:!1,content:`\u521B\u5EFA\u77E5\u8BC6\u70B9\u9875\u9762\u5931\u8D25: ${t.message}`}}}}),this.tools.set("create_and_index_page",{name:"create_and_index_page",description:"\u4E00\u7AD9\u5F0F\u521B\u5EFA\u77E5\u8BC6\u9875\u9762 + \u66F4\u65B0\u7D22\u5F15 + \u8FFD\u52A0\u65E5\u5FD7\u3002\u63A8\u8350\u4F7F\u7528\u6B64\u5DE5\u5177\u66FF\u4EE3\u5206\u522B\u8C03\u7528 create_knowledge_page + update_index + append_vault_file",parameters:{type:"object",properties:{page_type:{type:"string",description:"\u9875\u9762\u7C7B\u578B\uFF1Aknowledge=\u77E5\u8BC6\u70B9, person=\u4EBA\u7269\u4F20\u8BB0, organization=\u7EC4\u7EC7\u6863\u6848",enum:["knowledge","person","organization"]},category:{type:"string",description:"\u77E5\u8BC6\u70B9\u5206\u7C7B\uFF08page_type=knowledge\u65F6\u5FC5\u586B\uFF09\uFF0C\u5982\uFF1A\u6838\u5FC3\u6982\u5FF5\u3001\u65B9\u6CD5\u8BBA"},title:{type:"string",description:"\u9875\u9762\u6807\u9898/\u77E5\u8BC6\u70B9\u540D\u79F0"},content:{type:"string",description:"\u5B8C\u6574\u7684markdown\u9875\u9762\u5185\u5BB9\uFF08\u5FC5\u987B\u5305\u542B\u5168\u90E89\u4E2A\u7AE0\u8282\uFF09"},entry_category:{type:"string",description:"\u7D22\u5F15\u4E2D\u7684\u5206\u7C7B\u540D\uFF08\u53EF\u9009\uFF0C\u9ED8\u8BA4\u4E0Ecategory\u76F8\u540C\uFF09"},entry_description:{type:"string",description:"\u7D22\u5F15\u6761\u76EE\u7684\u4E00\u53E5\u8BDD\u63CF\u8FF0\uFF08\u53EF\u9009\uFF09"},maturity:{type:"string",description:"\u6210\u719F\u5EA6\u7EA7\u522B",enum:["\u5B8C\u6574\u7EA7","\u57FA\u7840\u7EA7","\u6846\u67B6\u7EA7"]},keywords:{type:"string",description:"\u65B0\u589E\u5173\u952E\u8BCD\uFF0C\u9017\u53F7\u5206\u9694\uFF08\u53EF\u9009\uFF09"}},required:["page_type","title","content"]},execute:async e=>{var t,n;try{let s=(0,a.normalizePath)(this.settings.knowledgeBasePath),i=new Date().toISOString().split("T")[0],o=(t=e.maturity)!=null&&t.includes("\u5B8C\u6574")?"\u{1F7E2}":(n=e.maturity)!=null&&n.includes("\u6846\u67B6")?"\u{1F534}":"\u{1F7E1}",c=e.category||"\u672A\u5206\u7C7B";e.page_type==="person"?c="\u4EBA\u7269\u4F20\u8BB0":e.page_type==="organization"&&(c="\u7EC4\u7EC7\u6863\u6848");let p=`${s}/10-\u77E5\u8BC6\u70B9\u5E93/${c}`;await this.ensureFolder(p);let u=`${p}/${e.title}.md`,h=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(u));if(h&&h instanceof a.TFile)return{success:!1,content:`\u9875\u9762\u5DF2\u5B58\u5728\uFF0C\u7981\u6B62\u8986\u76D6\uFF1A${u}\u3002\u8BF7\u4F7F\u7528 update_knowledge_page \u8FFD\u52A0\u5185\u5BB9\u3002`};await this.createFileOnly(u,e.content);let m=e.entry_category||c,r=`${s}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,l=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(r));if(l&&l instanceof a.TFile){let g=await this.app.vault.read(l),_=m.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),w=new RegExp(`###\\s+\\d+\\.\\s+${_}\\s*\\(\\d+\u4E2A\\)`),v=g.match(w);if(v){let k=g.indexOf(v[0]),C=g.indexOf(`
### `,k+1),L=C===-1?g.indexOf(`
---`,k):C,M=g.substring(k,L),T=M.match(/\((\d+)个\)/),S=T?parseInt(T[1]):0,A=M.replace(`(${S}\u4E2A)`,`(${S+1}\u4E2A)`).replace(/（暂无知识点）/,""),E=`- [[${e.title}]] ${o} - ${e.entry_description||"\u5F85\u8865\u5145"}`,N=g.substring(0,k)+A.trimEnd()+`
`+E+`
`+g.substring(L);await this.app.vault.modify(l,N);let W=N.match(/知识点总数：(\d+)个/);if(W){let J=parseInt(W[1])+1;await this.app.vault.modify(l,N.replace(`\u77E5\u8BC6\u70B9\u603B\u6570\uFF1A${W[1]}\u4E2A`,`\u77E5\u8BC6\u70B9\u603B\u6570\uFF1A${J}\u4E2A`))}}if(e.keywords){let k=`${s}/20-\u77E5\u8BC6\u7D22\u5F15/\u5173\u952E\u8BCD\u7D22\u5F15.md`,C=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(k));if(C&&C instanceof a.TFile){let L=await this.app.vault.read(C),M=e.keywords.split(",").map(T=>`| ${T.trim()} | [[${e.title}]] | 1 |`).join(`
`);await this.app.vault.modify(C,L.replace("\uFF08\u6682\u65E0\u5173\u952E\u8BCD\uFF09",M))}}}let d=`${s}/30-\u7EF4\u62A4\u8BB0\u5F55/\u77E5\u8BC6\u5E93\u66F4\u65B0\u65E5\u5FD7.md`,f=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(d)),y=`
## ${i} | \u65B0\u5EFA\u77E5\u8BC6\u70B9\uFF1A${e.title}
...
---
`;if(f&&f instanceof a.TFile){let g=await this.app.vault.read(f);await this.app.vault.modify(f,g+y)}else await this.createFileOnly(d,`# \u77E5\u8BC6\u5E93\u66F4\u65B0\u65E5\u5FD7
...
`)}catch(d){o=e.contributions}let c="> [\u5F85\u8865\u5145]";if(e.quotes)try{c=JSON.parse(e.quotes).map(f=>`> "${f.content||f.text}"
> \u2014\u2014 ${f.source||"\u51FA\u5904\u5F85\u8865\u5145"}`).join(`

`)}catch(d){c=e.quotes}let p=(e.related_topics||"").split(",").filter(d=>d.trim()).map(d=>`- [[${d.trim()}]]`).join(`
`),u=(e.related_orgs||"").split(",").filter(d=>d.trim()).map(d=>`- [[${d.trim()}]]`).join(`
`),h=(e.source_refs||"").split(",").filter(d=>d.trim()).map(d=>`- [[${d.trim()}]]`).join(`
`),m=`# ${e.name}
...
|------|---------|---------|----------|
| ${s} | \u521B\u5EFA | \u7528\u6237\u6307\u4EE4 | \u521D\u59CB\u5316\u9875\u9762 |
`,r=`${n}/${e.name}.md`,l=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(r));return l&&l instanceof a.TFile?{success:!1,content:`\u4EBA\u7269\u4F20\u8BB0\u9875\u9762\u5DF2\u5B58\u5728\uFF0C\u7981\u6B62\u8986\u76D6\uFF1A${r}\u3002\u8BF7\u4F7F\u7528 update_knowledge_page \u8FFD\u52A0\u5185\u5BB9\u3002`}:(await this.createFileOnly(r,m),{success:!0,content:`\u4EBA\u7269\u4F20\u8BB0\u9875\u9762\u5DF2\u521B\u5EFA: ${r}
...
[\u5F85\u8865\u5145]`;if(e.events)try{o=JSON.parse(e.events).map((d,f)=>`### \u4E8B\u4EF6${f+1}\uFF1A${d.name||d.title}

${d.content||d.description||""}`).join(`

`)}catch(l){o=e.events}let c=(e.key_figures||"").split(",").filter(l=>l.trim()).map(l=>`- [[${l.trim()}]]`).join(`
`),p=(e.related_topics||"").split(",").filter(l=>l.trim()).map(l=>`- [[${l.trim()}]]`).join(`
`),u=(e.source_refs||"").split(",").filter(l=>l.trim()).map(l=>`- [[${l.trim()}]]`).join(`
`),h=`# ${e.name}
...
|------|---------|---------|----------|
| ${s} | \u521B\u5EFA | \u7528\u6237\u6307\u4EE4 | \u521D\u59CB\u5316\u9875\u9762 |
`,m=`${n}/${e.name}.md`,r=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(m));return r&&r instanceof a.TFile?{success:!1,content:`\u7EC4\u7EC7\u6863\u6848\u9875\u9762\u5DF2\u5B58\u5728\uFF0C\u7981\u6B62\u8986\u76D6\uFF1A${m}\u3002\u8BF7\u4F7F\u7528 update_knowledge_page \u8FFD\u52A0\u5185\u5BB9\u3002`}:(await this.createFileOnly(m,h),{success:!0,content:`\u7EC4\u7EC7\u6863\u6848\u9875\u9762\u5DF2\u521B\u5EFA: ${m}

\u8BF7\u7EE7\u7EED\u6267\u884C\uFF1A
1. \u4F7F\u7528 update_index \u5DE5\u5177\u66F4\u65B0\u7D22\u5F15
2. \u5728\u81F3\u5C113\u4E2A\u5DF2\u6709\u9875\u9762\u4E2D\u6DFB\u52A0\u5165\u94FE
3. \u8FFD\u52A0\u66F4\u65B0\u65E5\u5FD7`})}catch(t){return{success:!1,content:`\u521B\u5EFA\u7EC4\u7EC7\u6863\u6848\u9875\u9762\u5931\u8D25: ${t.message}`}}}}),this.tools.set("update_knowledge_page",{name:"update_knowledge_page",description:"\u5411\u5DF2\u6709\u7684\u77E5\u8BC6\u70B9\u9875\u9762\u8FFD\u52A0\u5185\u5BB9\u3002\u4E0D\u53EF\u66FF\u6362\u6216\u5220\u9664\u5DF2\u6709\u5185\u5BB9",parameters:{type:"object",properties:{path:{type:"string",description:"\u77E5\u8BC6\u70B9\u9875\u9762\u7684\u8DEF\u5F84"},section:{type:"string",description:"\u8981\u66F4\u65B0\u7684\u7AE0\u8282\u6838\u5FC3\u540D\u79F0\uFF0C\u5982\uFF1A\u6838\u5FC3\u5B9A\u4E49\u3001\u6838\u5FC3\u8981\u70B9\u3001\u7ECF\u5178\u6848\u4F8B\u3001\u5B9E\u8DF5\u65B9\u6CD5\u3001\u5E38\u89C1\u8BEF\u533A\u3001\u76F8\u5173\u77E5\u8BC6\u70B9\u3001\u539F\u6587\u51FA\u5904\u3001\u542F\u793A\u3001\u66F4\u65B0\u65E5\u5FD7"},content:{type:"string",description:"\u8981\u8FFD\u52A0\u7684\u7AE0\u8282\u5185\u5BB9\uFF08\u53EA\u5199\u7AE0\u8282\u5185\u5BB9\u672C\u8EAB\uFF0C\u4E0D\u5305\u542B\u7AE0\u8282\u6807\u9898\uFF09"},append_mode:{type:"string",description:"\u56FA\u5B9A\u4E3A append\uFF08\u5728\u7AE0\u8282\u672B\u5C3E\u8FFD\u52A0\u5185\u5BB9\uFF09\u3002\u6CE8\u610F\uFF1A\u4E0D\u652F\u6301 replace\uFF0C\u4E0D\u5F97\u5220\u9664\u5DF2\u6709\u5185\u5BB9",enum:["append"]}},required:["path","section","content"]},execute:async e=>{try{let t=(0,a.normalizePath)(e.path),n=this.app.vault.getAbstractFileByPath(t);if(!n||!(n instanceof a.TFile))return{success:!1,content:`\u6587\u4EF6\u4E0D\u5B58\u5728: ${t}`};let s=await this.app.vault.read(n),o={\u6838\u5FC3\u5B9A\u4E49:["\u6838\u5FC3\u5B9A\u4E49","\u6838\u5FC3\u5B9A\u4E49"],\u6838\u5FC3\u8981\u70B9:["\u6838\u5FC3\u8981\u70B9","\u8981\u70B9"],\u7ECF\u5178\u6848\u4F8B:["\u7ECF\u5178\u6848\u4F8B","\u6848\u4F8B"],\u5B9E\u8DF5\u65B9\u6CD5:["\u5B9E\u8DF5\u65B9\u6CD5","\u65B9\u6CD5"],\u5E38\u89C1\u8BEF\u533A:["\u5E38\u89C1\u8BEF\u533A","\u8BEF\u533A"],\u76F8\u5173\u77E5\u8BC6\u70B9:["\u76F8\u5173\u77E5\u8BC6\u70B9","\u5173\u8054"],\u539F\u6587\u51FA\u5904:["\u539F\u6587\u51FA\u5904","\u51FA\u5904"],\u542F\u793A:["\u542F\u793A","\u5BF9\u76EE\u6807\u4EBA\u7FA4\u7684\u542F\u793A"],\u66F4\u65B0\u65E5\u5FD7:["\u66F4\u65B0\u65E5\u5FD7","\u65E5\u5FD7"]}[e.section]||[e.section],c=-1,p="";for(let w of o){let v=new RegExp(`##\\s*[\\d\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u3001\\.]*\\s*${w.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}`),k=s.match(v);if(k){c=k.index,p=k[0];break}}if(c===-1){let w=new RegExp(`##\\s*[\\d\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u3001\\.]*\\s*${e.section.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}`),v=s.match(w);if(v)c=v.index,p=v[0];else return{success:!1,content:`\u672A\u627E\u5230\u7AE0\u8282\u300C${e.section}\u300D\u3002\u6587\u4EF6\u4E2D\u7684\u7AE0\u8282\u6807\u9898\u683C\u5F0F\u53EF\u80FD\u4E0D\u540C\uFF0C\u8BF7\u5148\u4F7F\u7528 read_vault_file \u8BFB\u53D6\u6587\u4EF6\u67E5\u770B\u5B9E\u9645\u7AE0\u8282\u540D\u79F0`}}let u=s.indexOf(`
## `,c+p.length),h=u===-1?s.length:u,m=s.substring(0,c),r=s.substring(h),l=s.substring(c,h),d=m+l+`

`+e.content+r,y=`| ${new Date().toISOString().split("T")[0]} | \u4FEE\u6539 | \u7528\u6237\u6307\u4EE4 | \u66F4\u65B0${e.section}\u7AE0\u8282 |`,g=/##\s*[一二三四五六七八九十、]*\s*更新日志/,_=d.match(g);if(_){let w=_.index,v=d.indexOf("| \u65E5\u671F |",w);if(v!==-1){let k=d.indexOf(`
`,v),C=d.indexOf(`
`,k+1);d=d.substring(0,C+1)+y+`
`+d.substring(C+1)}}return await this.app.vault.modify(n,d),{success:!0,content:`\u7AE0\u8282\u300C${e.section}\u300D\u5DF2\u66F4\u65B0: ${t}

\u8BF7\u6267\u884C\u81EA\u68C0\u6E05\u5355\u5E76\u66F4\u65B0\u96C6\u4E2D\u65E5\u5FD7\u3002`}}catch(t){return{success:!1,content:`\u66F4\u65B0\u77E5\u8BC6\u70B9\u9875\u9762\u5931\u8D25: ${t.message}`}}}}),this.tools.set("update_index",{name:"update_index",description:"\u66F4\u65B0\u77E5\u8BC6\u5E93\u7D22\u5F15\u6587\u4EF6\uFF08\u603B\u7D22\u5F15\u3001\u5173\u952E\u8BCD\u7D22\u5F15\u3001\u5173\u7CFB\u56FE\u8C31\uFF09",parameters:{type:"object",properties:{action:{type:"string",description:"\u66F4\u65B0\u7C7B\u578B",enum:["add_entry","refresh_all"]},entry_name:{type:"string",description:"\u6761\u76EE\u540D\u79F0"},entry_category:{type:"string",description:"\u6761\u76EE\u5206\u7C7B"},entry_description:{type:"string",description:"\u4E00\u53E5\u8BDD\u63CF\u8FF0"},entry_maturity:{type:"string",description:"\u6210\u719F\u5EA6",enum:["\u{1F7E2}","\u{1F7E1}","\u{1F534}"]},keywords:{type:"string",description:"\u65B0\u589E\u5173\u952E\u8BCD\uFF0C\u9017\u53F7\u5206\u9694"}},required:["action"]},execute:async e=>{try{let t=(0,a.normalizePath)(this.settings.knowledgeBasePath),n=`${t}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,s=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(n));if(!s||!(s instanceof a.TFile))return{success:!1,content:`\u7D22\u5F15\u6587\u4EF6\u4E0D\u5B58\u5728: ${n}`};if(e.action==="add_entry"&&e.entry_name&&e.entry_category){let i=await this.app.vault.read(s),o=e.entry_category,c=new RegExp(`###\\s+\\d+\\.\\s+${o.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}\\s*\\(\\d+\u4E2A\\)`),p=i.match(c);if(p){let u=i.indexOf(p[0]),h=i.indexOf(`
### `,u+1),m=h===-1?i.indexOf(`
---`,u):h,r=i.substring(u,m),l=r.match(/\((\d+)个\)/),d=l?parseInt(l[1]):0,f=d+1,y=r.replace(`(${d}\u4E2A)`,`(${f}\u4E2A)`).replace(/（暂无知识点）/,""),g=e.entry_maturity||"\u{1F7E1}",_=`- [[${e.entry_name}]] ${g} - ${e.entry_description||"\u5F85\u8865\u5145"}`,w=i.substring(0,u)+y.trimEnd()+`
`+_+`
`+i.substring(m);await this.app.vault.modify(s,w);let v=w.match(/知识点总数：(\d+)个/);if(v){let k=parseInt(v[1])+1,C=w.replace(`\u77E5\u8BC6\u70B9\u603B\u6570\uFF1A${v[1]}\u4E2A`,`\u77E5\u8BC6\u70B9\u603B\u6570\uFF1A${k}\u4E2A`);await this.app.vault.modify(s,C)}}if(e.keywords){let u=`${t}/20-\u77E5\u8BC6\u7D22\u5F15/\u5173\u952E\u8BCD\u7D22\u5F15.md`,h=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(u));if(h&&h instanceof a.TFile){let m=await this.app.vault.read(h),r=e.keywords.split(",").map(d=>`| ${d.trim()} | [[${e.entry_name}]] | 1 |`).join(`
`),l=m.replace("\uFF08\u6682\u65E0\u5173\u952E\u8BCD\uFF09",r);await this.app.vault.modify(h,l)}}return{success:!0,content:`\u7D22\u5F15\u5DF2\u66F4\u65B0\uFF1A\u6DFB\u52A0 ${e.entry_name} \u5230 ${e.entry_category}`}}return e.action==="refresh_all"?{success:!0,content:"\u8BF7\u4F7F\u7528 list_vault_folder \u5DE5\u5177\u626B\u63CF\u5404\u5206\u7C7B\u76EE\u5F55\uFF0C\u7136\u540E\u624B\u52A8\u66F4\u65B0\u7D22\u5F15\u6570\u91CF\u3002"}:{success:!0,content:"\u7D22\u5F15\u66F4\u65B0\u64CD\u4F5C\u5B8C\u6210"}}catch(t){return{success:!1,content:`\u66F4\u65B0\u7D22\u5F15\u5931\u8D25: ${t.message}`}}}}),this.tools.set("query_knowledge",{name:"query_knowledge",description:"\u67E5\u8BE2\u77E5\u8BC6\u5E93\uFF1A\u5148\u8BFB\u53D6\u7D22\u5F15\u4E86\u89E3\u7ED3\u6784\uFF0C\u518D\u8BFB\u53D6\u76F8\u5173\u77E5\u8BC6\u70B9\u9875\u9762",parameters:{type:"object",properties:{query:{type:"string",description:"\u67E5\u8BE2\u95EE\u9898\u6216\u5173\u952E\u8BCD"}},required:["query"]},execute:async e=>{try{let n=`${(0,a.normalizePath)(this.settings.knowledgeBasePath)}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,s=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(n));if(!s||!(s instanceof a.TFile))return{success:!1,content:`\u77E5\u8BC6\u5E93\u7D22\u5F15\u4E0D\u5B58\u5728\uFF0C\u8BF7\u5148\u521D\u59CB\u5316\u77E5\u8BC6\u5E93\u3002\u7D22\u5F15\u8DEF\u5F84: ${n}`};let i=await this.app.vault.read(s),o=e.query.toLowerCase(),c=i.split(`
`),p=[];for(let h of c)h.includes("[[")&&h.toLowerCase().includes(o.split(" ")[0])&&p.push(h.trim());let u=`\u77E5\u8BC6\u5E93\u7D22\u5F15\u6982\u89C8:
${i.substring(0,2e3)}

`;return p.length>0?u+=`\u4E0E "${e.query}" \u76F8\u5173\u7684\u6761\u76EE:
${p.join(`
`)}

`:u+=`\u5728\u7D22\u5F15\u4E2D\u672A\u627E\u5230\u4E0E "${e.query}" \u76F4\u63A5\u5339\u914D\u7684\u6761\u76EE\u3002

`,u+="\u8BF7\u6839\u636E\u4EE5\u4E0A\u7D22\u5F15\u4FE1\u606F\uFF0C\u4F7F\u7528 read_vault_file \u5DE5\u5177\u8BFB\u53D6\u76F8\u5173\u77E5\u8BC6\u70B9\u9875\u9762\u7684\u8BE6\u7EC6\u5185\u5BB9\u6765\u56DE\u7B54\u7528\u6237\u95EE\u9898\u3002",{success:!0,content:u}}catch(t){return{success:!1,content:`\u67E5\u8BE2\u77E5\u8BC6\u5E93\u5931\u8D25: ${t.message}`}}}}),this.tools.set("lint_knowledge_base",{name:"lint_knowledge_base",description:"\u5BF9\u77E5\u8BC6\u5E93\u6267\u884C\u6574\u7406\u68C0\u67E5\uFF1A\u68C0\u67E5\u77DB\u76FE\u3001\u5B64\u7ACB\u9875\u9762\u3001\u683C\u5F0F\u95EE\u9898\u7B49",parameters:{type:"object",properties:{check_type:{type:"string",description:"\u68C0\u67E5\u7C7B\u578B",enum:["full","format","content","links"]}},required:[]},execute:async e=>{try{let t=(0,a.normalizePath)(this.settings.knowledgeBasePath),n=e.check_type||"full",s=[],i=`${t}/10-\u77E5\u8BC6\u70B9\u5E93`,o=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(i));if(!o||!(o instanceof a.TFolder))return{success:!1,content:`\u77E5\u8BC6\u70B9\u5E93\u76EE\u5F55\u4E0D\u5B58\u5728: ${i}`};let c=[],p=[],u=new Set,h=r=>{for(let l of r.children)l instanceof a.TFile?(c.push(l),u.add(l.basename),l.stat.size===0&&p.push(l)):l instanceof a.TFolder&&h(l)};if(h(o),p.length>0&&s.push(`\u26A0\uFE0F \u53D1\u73B0 ${p.length} \u4E2A\u7A7A\u6587\u4EF6:
${p.map(r=>`  - ${r.path}`).join(`
`)}`),n==="full"||n==="links"){let r=[],l=new Set;for(let d of c.slice(0,50)){let y=(await this.app.vault.cachedRead(d)).matchAll(/\[\[([^\]]+)\]\]/g);for(let g of y)l.add(g[1].split("|")[0].split("#")[0].trim())}for(let d of u)l.has(d)||r.push(d);r.length>0&&s.push(`\u{1F517} \u53D1\u73B0 ${r.length} \u4E2A\u5B64\u7ACB\u9875\u9762\uFF08\u65E0\u5165\u94FE\uFF09:
${r.slice(0,20).map(d=>`  - ${d}`).join(`
`)}`)}if(n==="full"||n==="format")for(let r of c.slice(0,30)){let l=await this.app.vault.cachedRead(r);l.includes("## \u4E5D\u3001\u66F4\u65B0\u65E5\u5FD7")||s.push(`\u{1F4DD} ${r.basename} \u7F3A\u5C11"\u66F4\u65B0\u65E5\u5FD7"\u7AE0\u8282`),l.includes("## \u4E03\u3001\u539F\u6587\u51FA\u5904")||s.push(`\u{1F4DD} ${r.basename} \u7F3A\u5C11"\u539F\u6587\u51FA\u5904"\u7AE0\u8282`)}if(n==="full"||n==="content"){let r=`${t}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,l=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(r));if(l&&l instanceof a.TFile){let f=(await this.app.vault.read(l)).matchAll(/\((\d+)个\)/g);for(let y of f)parseInt(y[1])>0&&s.push(`\u{1F4CA} \u5206\u7C7B\u8BA1\u6570 ${y[0]} \u9700\u8981\u9A8C\u8BC1\u662F\u5426\u4E0E\u5B9E\u9645\u6587\u4EF6\u6570\u4E00\u81F4`)}}return{success:!0,content:s.length>0?`Lint \u68C0\u67E5\u5B8C\u6210\uFF0C\u53D1\u73B0 ${s.length} \u4E2A\u95EE\u9898:
...
\u8BF7\u4F7F\u7528 init_knowledge_base \u5DE5\u5177\u521D\u59CB\u5316\u77E5\u8BC6\u5E93\u3002`};let s={},i={"\u{1F7E2}":0,"\u{1F7E1}":0,"\u{1F534}":0},o=r=>{let l=0;for(let d of r.children)d instanceof a.TFile?l++:d instanceof a.TFolder&&(l+=o(d));return l};for(let r of n.children)r instanceof a.TFolder&&(s[r.name]=o(r));let c=`${t}/10-\u77E5\u8BC6\u70B9\u5E93`,p=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(c));if(p&&p instanceof a.TFolder){for(let r of p.children)if(r instanceof a.TFolder){for(let l of r.children)if(l instanceof a.TFile){let d=await this.app.vault.cachedRead(l);d.includes("\u{1F7E2}")?i["\u{1F7E2}"]++:d.includes("\u{1F7E1}")?i["\u{1F7E1}"]++:d.includes("\u{1F534}")&&i["\u{1F534}"]++}}}let u=`${t}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,h=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(u)),m="\u672A\u77E5";return h&&h instanceof a.TFile&&(m=new Date(h.stat.mtime).toLocaleString("zh-CN")),{success:!0,content:`\u{1F4CA} \u77E5\u8BC6\u5E93\u72B6\u6001\u62A5\u544A

\u8DEF\u5F84: ${t}
\u6700\u540E\u66F4\u65B0: ${m}

\u{1F4C1} \u76EE\u5F55\u7EDF\u8BA1:
${Object.entries(s).map(([r,l])=>`  - ${r}: ${l} \u4E2A\u6587\u4EF6`).join(`
`)}
...
`),c=o.findIndex(p=>p.startsWith(`- **${e.key}**:`));c>=0?o[c]=`- **${e.key}**: ${e.value} (_${s}_)`:o.push(`- **${e.key}**: ${e.value} (_${s}_)`),await this.app.vault.modify(n,o.join(`
...
`):"\u6682\u65E0\u8BB0\u5FC6\u8BB0\u5F55"}}catch(t){return{success:!1,content:`\u8BFB\u53D6\u8BB0\u5FC6\u5931\u8D25: ${t.message}`}}}})}getToolDefinitions(){let e=[];for(let[t,n]of this.tools)e.push({type:"function",function:{name:n.name,description:n.description,parameters:n.parameters}});return e}async executeTool(e,t){let n=this.tools.get(e);return n?await n.execute(t):{success:!1,content:`\u672A\u77E5\u5DE5\u5177: ${e}`}}async ensureFolder(e){if(!e)return;let t=(0,a.normalizePath)(e).split("/"),n="";for(let s of t)n=n?`${n}/${s}`:s,this.app.vault.getAbstractFileByPath(n)||await this.app.vault.createFolder(n)}async createFileOnly(e,t){let n=(0,a.normalizePath)(e);if(this.isUnderRawMaterials(n))return;let i=this.app.vault.getAbstractFileByPath(n);i&&i instanceof a.TFile||await this.app.vault.create(n,t)}isUnderRawMaterials(e){let t=(0,a.normalizePath)(this.settings.knowledgeBasePath),n=(0,a.normalizePath)(e),s=`${t}/00-\u539F\u59CB\u8D44\u6599`;return n===s||n.startsWith(s+"/")?n:null}};var P=require("obsidian"),F="llm-wiki-chat-view",j=class extends P.ItemView{constructor(t,n){super(t);this.isProcessing=!1;this.currentAssistantEl=null;this.currentContent="";this.renderTimer=null;this.tokenBuffer="";this.toolCardEl=null;this.plugin=n}getViewType(){return F}getDisplayText(){return"LLM Wiki \u77E5\u8BC6\u5E93\u52A9\u624B"}getIcon(){return"message-square"}async onOpen(){let t=this.containerEl.children[1];t.empty(),t.addClass("llm-wiki-root"),this.buildUI(t),await this.loadChatHistory()}onClose(){this.saveChatHistory()}buildUI(t){t.style.display="flex",t.style.flexDirection="column",t.style.height="100%";let n=t.createEl("div",{cls:"llm-wiki-chat-header"});n.createEl("h3",{text:"\u{1F4AC} LLM Wiki \u77E5\u8BC6\u5E93\u52A9\u624B"}),n.createEl("div",{cls:"llm-wiki-header-actions"}).createEl("button",{text:"\u65B0\u5BF9\u8BDD",cls:"llm-wiki-btn"}).addEventListener("click",()=>this.newConversation()),this.messagesEl=t.createEl("div",{cls:"llm-wiki-messages"});let o=t.createEl("div",{cls:"llm-wiki-input-container"});this.inputEl=o.createEl("textarea",{cls:"llm-wiki-input",attr:{placeholder:"\u8F93\u5165\u60A8\u7684\u95EE\u9898...",rows:"2"}}),this.inputEl.addEventListener("keydown",h=>{h.key==="Enter"&&!h.shiftKey&&(h.preventDefault(),this.sendMessage())});let c=o.createEl("div",{cls:"llm-wiki-hints"}),p=[{text:"\u521D\u59CB\u5316\u77E5\u8BC6\u5E93",tip:"\u521B\u5EFA\u4E13\u9898\u77E5\u8BC6\u5E93\u76EE\u5F55\u7ED3\u6784"},{text:"\u6444\u53D6\u8D44\u6599",tip:"\u5904\u7406\u539F\u59CB\u8D44\u6599\u6587\u4EF6"},{text:"\u67E5\u8BE2\u77E5\u8BC6",tip:"\u641C\u7D22\u77E5\u8BC6\u5E93\u5185\u5BB9"},{text:"Lint \u68C0\u67E5",tip:"\u6267\u884C\u6574\u7406\u68C0\u67E5"},{text:"\u77E5\u8BC6\u5E93\u72B6\u6001",tip:"\u67E5\u770B\u77E5\u8BC6\u5E93\u6982\u51B5"}];for(let h of p)c.createEl("span",{cls:"llm-wiki-hint-chip",text:h.text,attr:{title:h.tip}}).addEventListener("click",()=>{this.inputEl.value=h.text,this.inputEl.focus()});let u=o.createEl("div",{cls:"llm-wiki-btn-row"});this.sendBtn=u.createEl("button",{text:"\u53D1\u9001",cls:"llm-wiki-btn llm-wiki-btn-primary"}),this.sendBtn.addEventListener("click",()=>this.sendMessage()),this.stopBtn=u.createEl("button",{text:"\u505C\u6B62",cls:"llm-wiki-btn llm-wiki-btn-danger"}),this.stopBtn.style.display="none",this.stopBtn.addEventListener("click",()=>this.stopGeneration())}async newConversation(){var t;this.isProcessing||((t=this.plugin.agentCore)==null||t.clearHistory(),this.messagesEl.empty(),this.currentContent="",this.tokenBuffer="",this.addSystemMessage(`\u65B0\u5BF9\u8BDD\u5DF2\u5F00\u59CB\u3002\u60A8\u53EF\u4EE5\u8F93\u5165\u95EE\u9898\uFF0C\u6216\u5C1D\u8BD5\u4EE5\u4E0B\u6307\u4EE4\uFF1A
...
\u2022 **'Lint'** - \u6267\u884C\u6574\u7406\u68C0\u67E5
\u2022 **'\u521B\u5EFA\u77E5\u8BC6\u70B9'** - \u65B0\u5EFA\u77E5\u8BC6\u70B9\u9875\u9762
\u2022 **'\u77E5\u8BC6\u5E93\u72B6\u6001'** - \u67E5\u770B\u77E5\u8BC6\u5E93\u6982\u51B5`))}async sendMessage(){let t=this.inputEl.value.trim();if(!(!t||this.isProcessing)){this.inputEl.value="",this.isProcessing=!0,this.sendBtn.style.display="none",this.stopBtn.style.display="inline-block",this.addUserMessage(t),this.addAssistantMessage("");try{let n=this.plugin.agentCore;if(!n){this.updateAssistantMessage("\u274C Agent \u672A\u521D\u59CB\u5316\uFF0C\u8BF7\u68C0\u67E5 API Key \u8BBE\u7F6E\u3002");return}let s=async i=>{this.finalizeAssistantMessage(),this.autoLog(t,i),await this.saveChatHistory()};this.plugin.settings.streamMode?await n.chatStream(t,{onToken:i=>this.appendToken(i),onToolCall:(i,o)=>this.showToolCall(i,o),onToolResult:(i,o)=>this.showToolResult(i,o),onComplete:s,onError:i=>{this.updateAssistantMessage(`\u274C ${i}`),this.finalizeAssistantMessage()}}):await n.chatNonStream(t,{onToken:i=>this.appendToken(i),onToolCall:(i,o)=>this.showToolCall(i,o),onToolResult:(i,o)=>this.showToolResult(i,o),onComplete:s,onError:i=>{this.updateAssistantMessage(`\u274C ${i}`),this.finalizeAssistantMessage()}})}catch(n){this.updateAssistantMessage(`\u274C \u53D1\u751F\u9519\u8BEF: ${n.message}`)}finally{this.isProcessing=!1,this.sendBtn.style.display="inline-block",this.stopBtn.style.display="none",this.toolCardEl=null,this.inputEl.focus()}}}stopGeneration(){var t;(t=this.plugin.agentCore)==null||t.abort(),this.isProcessing=!1,this.sendBtn.style.display="inline-block",this.stopBtn.style.display="none"}async addUserMessage(t){let n=this.messagesEl.createEl("div",{cls:"llm-wiki-message llm-wiki-user-message"});n.createEl("div",{cls:"llm-wiki-message-sender",text:"\u4F60"});let s=n.createEl("div",{cls:"llm-wiki-message-content"});await P.MarkdownRenderer.renderMarkdown(t,s,"",this.plugin),this.scrollToBottom()}addSystemMessage(t){let s=this.messagesEl.createEl("div",{cls:"llm-wiki-message llm-wiki-system-message"}).createEl("div",{cls:"llm-wiki-message-content"});P.MarkdownRenderer.renderMarkdown(t,s,"",this.plugin)}addAssistantMessage(t){let n=this.messagesEl.createEl("div",{cls:"llm-wiki-message llm-wiki-assistant-message"});n.createEl("div",{cls:"llm-wiki-message-sender",text:"Agent"}),this.currentAssistantEl=n.createEl("div",{cls:"llm-wiki-message-content"}),this.currentContent=t,this.tokenBuffer=""}updateAssistantMessage(t){this.currentAssistantEl&&(this.currentContent=t,this.currentAssistantEl.empty(),P.MarkdownRenderer.renderMarkdown(t,this.currentAssistantEl,"",this.plugin),this.scrollToBottom())}appendToken(t){this.currentContent+=t,this.tokenBuffer+=t,this.renderTimer||(this.renderTimer=setInterval(()=>this.flushTokenBuffer(),50)),this.scrollToBottom()}flushTokenBuffer(){this.renderTimer&&(clearInterval(this.renderTimer),this.renderTimer=null),this.tokenBuffer&&this.currentAssistantEl&&(this.currentAssistantEl.empty(),P.MarkdownRenderer.renderMarkdown(this.currentContent,this.currentAssistantEl,"",this.plugin),this.tokenBuffer="")}finalizeAssistantMessage(){this.flushTokenBuffer(),this.currentAssistantEl=null,this.currentContent=""}showToolCall(t,n){let s=JSON.stringify(n,null,2);if(this.currentAssistantEl){let i=this.currentAssistantEl.createEl("div",{cls:"llm-wiki-tool-card llm-wiki-tool-running"});i.createEl("div",{cls:"llm-wiki-tool-name",text:`\u{1F7E1} \u8C03\u7528\u5DE5\u5177: ${t}`});let o=i.createEl("pre",{cls:"llm-wiki-tool-args"});o.textContent=s,this.toolCardEl=i}this.scrollToBottom()}showToolResult(t,n){if(this.toolCardEl){let s=n.success?`\u{1F7E2} ${t} \u5B8C\u6210`:`\u{1F534} ${t} \u5931\u8D25`,i=this.toolCardEl.querySelector(".llm-wiki-tool-name");if(i&&(i.textContent=s),this.toolCardEl.removeClass("llm-wiki-tool-running"),this.toolCardEl.addClass(n.success?"llm-wiki-tool-success":"llm-wiki-tool-error"),n.content){let o=this.toolCardEl.createEl("div",{cls:"llm-wiki-tool-result"});o.textContent=n.content.length>300?n.content.substring(0,300)+"...":n.content}this.toolCardEl=null}this.scrollToBottom()}scrollToBottom(){this.messagesEl.scrollTop=this.messagesEl.scrollHeight}async autoLog(t,n){if(!(!this.plugin.settings.autoLog||!this.plugin.memoryService))try{let s=t.length>50?t.substring(0,50)+"...":t,i=n.length>200?n.substring(0,200)+"...":n;await this.plugin.memoryService.writeLog(s,`\u7528\u6237: ${t}`,i)}catch(s){}}async saveChatHistory(){var t;try{let n=(t=this.plugin.agentCore)==null?void 0:t.getHistory();if(!n||n.length===0)return;let s={messages:n,savedAt:new Date().toISOString()},i=(0,P.normalizePath)(`${this.plugin.settings.memoryFolder}/\u5BF9\u8BDD\u5386\u53F2.json`),o=this.app.vault.getAbstractFileByPath(i);o&&o instanceof P.TFile?await this.app.vault.modify(o,JSON.stringify(s,null,2)):await this.app.vault.create(i,JSON.stringify(s,null,2))}catch(n){}}async loadChatHistory(){var t;try{let n=(0,P.normalizePath)(`${this.plugin.settings.memoryFolder}/\u5BF9\u8BDD\u5386\u53F2.json`),s=this.app.vault.getAbstractFileByPath(n);if(!s||!(s instanceof P.TFile)){this.addSystemMessage(`\u6B22\u8FCE\u4F7F\u7528 LLM Wiki \u77E5\u8BC6\u5E93\u52A9\u624B\uFF01

\u8BF7\u5148\u5B8C\u6210\u4EE5\u4E0B\u8BBE\u7F6E\uFF1A
1. \u5728\u8BBE\u7F6E\u4E2D\u586B\u5199 API Key\uFF08\u652F\u6301 OpenAI / DeepSeek / \u7845\u57FA\u6D41\u52A8\u7B49\uFF09
2. \u8BBE\u7F6E\u77E5\u8BC6\u5E93\u8DEF\u5F84

\u7136\u540E\u5C31\u53EF\u4EE5\u5F00\u59CB\u5BF9\u8BDD\u4E86\uFF01`);return}let i=await this.app.vault.read(s),o=JSON.parse(i);(t=this.plugin.agentCore)==null||t.setHistory(o.messages||[]);for(let c of o.messages||[])c.role==="user"?this.addUserMessage(c.content):c.role==="assistant"&&!c.tool_calls&&(this.addAssistantMessage(c.content),this.finalizeAssistantMessage())}catch(n){this.addSystemMessage("\u6B22\u8FCE\u56DE\u6765\uFF01\u4E0A\u6B21\u7684\u5BF9\u8BDD\u5386\u53F2\u52A0\u8F7D\u5931\u8D25\uFF0C\u5DF2\u5F00\u542F\u65B0\u5BF9\u8BDD\u3002")}}};var b=require("obsidian"),D=class{constructor(e,t){this.app=e,this.settings=t}updateSettings(e){this.settings=e}async loadSkillContent(){try{let e=(0,b.normalizePath)(`${this.settings.skillFolderPath}/SKILL.md`),t=this.app.vault.getAbstractFileByPath(e);if(t&&t instanceof b.TFile)return await this.app.vault.read(t)}catch(e){}return""}async loadReferencesContent(){try{let e=[],t=(0,b.normalizePath)(`${this.settings.skillFolderPath}/references`),n=this.app.vault.getAbstractFileByPath(t);if(n&&n instanceof b.TFolder){for(let s of n.children)if(s instanceof b.TFile&&s.extension==="md"){let i=await this.app.vault.read(s);e.push(`### ${s.name}

${i}`)}}return e.join(`

---

`)}catch(e){}return""}async loadMemoryContext(){let e=[],t=(0,b.normalizePath)(`${this.settings.memoryFolder}/\u957F\u671F\u8BB0\u5FC6.md`),n=this.app.vault.getAbstractFileByPath(t);n&&n instanceof b.TFile&&e.push(await this.app.vault.read(n));let s=(0,b.normalizePath)(`${this.settings.memoryFolder}/\u7528\u6237\u504F\u597D.md`),i=this.app.vault.getAbstractFileByPath(s);return i&&i instanceof b.TFile&&e.push(await this.app.vault.read(i)),e.join(`

---

`)}async writeLog(e,t,n){let s=new Date().toISOString().split("T")[0],i=(0,b.normalizePath)(`${this.settings.memoryFolder}/\u65E5\u5FD7/${s}.md`),o=`## ${new Date().toLocaleTimeString("zh-CN",{hour:"2-digit",minute:"2-digit"})} | ${e}
...
---
`,c=this.app.vault.getAbstractFileByPath(i);if(c&&c instanceof b.TFile){let p=await this.app.vault.read(c);await this.app.vault.modify(c,p+o)}else await this.ensureFolder(`${this.settings.memoryFolder}/\u65E5\u5FD7`),await this.app.vault.create(i,`# \u5DE5\u4F5C\u65E5\u5FD7 ${s}

${o}`)}async ensureFolder(e){if(!e)return;let t=(0,b.normalizePath)(e).split("/"),n="";for(let s of t)n=n?`${n}/${s}`:s,this.app.vault.getAbstractFileByPath(n)||await this.app.vault.createFolder(n)}};var R=class{constructor(){this.summaryCache=new Map;this.maxTokens=8e3}setMaxTokens(e){this.maxTokens=e}estimateTokens(e){return Math.ceil(e.length/2)}async compressHistory(e,t){let n=e.map(r=>r.content||"").join(`
`);if(this.estimateTokens(n)<=this.maxTokens)return e;let s=[],i=[];for(let r of e)i.push(r),r.role==="assistant"&&!r.tool_calls&&(s.push([...i]),i=[]);if(i.length>0&&s.push(i),s.length<=6)return e;let o=s.slice(-6),p=s.slice(0,-6).flat().map(r=>`${r.role}: ${r.content||""}`).join(`
`),u=this.hashText(p),h=this.summaryCache.get(u);if(!h)try{h=await t([{role:"system",content:"\u5C06\u4EE5\u4E0B\u5BF9\u8BDD\u5386\u53F2\u538B\u7F29\u4E3A\u4E00\u6BB5\u7B80\u6D01\u7684\u6458\u8981\uFF0C\u4FDD\u7559\u5173\u952E\u4FE1\u606F\u3001\u51B3\u7B56\u548C\u7ED3\u8BBA\uFF0C\u4E0D\u8D85\u8FC7500\u5B57\u3002\u5982\u679C\u6D89\u53CA\u77E5\u8BC6\u70B9\u5E93\u7684\u64CD\u4F5C\uFF0C\u4FDD\u7559\u6587\u4EF6\u8DEF\u5F84\u548C\u64CD\u4F5C\u7C7B\u578B\u3002"},{role:"user",content:p}]),this.summaryCache.set(u,h)}catch(r){h=`[\u65E9\u671F\u5BF9\u8BDD\u6458\u8981: ${p.substring(0,500)}...]`}return[{role:"assistant",content:`[\u5386\u53F2\u5BF9\u8BDD\u6458\u8981]
${h}`},...o.flat()]}hashText(e){let t=0;for(let n=0;n<e.length;n++){let s=e.charCodeAt(n);t=(t<<5)-t+s,t|=0}return`ctx_${t.toString(36)}`}getSummaryStats(e){let t=e.map(n=>n.content||"").join(`
`);return{originalTokens:this.estimateTokens(t),compressedTokens:Math.ceil(t.length/3),turns:e.filter(n=>n.role==="user").length}}};var q=class extends U.Plugin{async onload(){await this.loadSettings(),this.addSettingTab(new B(this.app,this)),this.toolRegistry=new I(this.app,this.settings),this.memoryService=new D(this.app,this.settings),this.contextManager=new R,await this.initAgent(),this.registerView(F,t=>new j(t,this)),this.addCommand({id:"open-llm-wiki-chat",name:"\u6253\u5F00 LLM Wiki \u77E5\u8BC6\u5E93\u52A9\u624B",callback:()=>this.activateChatView()}),this.addRibbonIcon("message-square","LLM Wiki \u77E5\u8BC6\u5E93\u52A9\u624B",()=>{this.activateChatView()}),this.applyTheme(),this.app.workspace.onLayoutReady(()=>{this.activateChatView()})}onunload(){this.app.workspace.detachLeavesOfType(F)}async initAgent(){let[t,n,s]=await Promise.all([this.memoryService.loadSkillContent(),this.memoryService.loadReferencesContent(),this.memoryService.loadMemoryContext()]);this.agentCore=new O(this.settings,this.toolRegistry),this.agentCore.init(t,n,s)}async activateChatView(){let{workspace:t}=this.app,n=t.getLeavesOfType(F)[0];if(!n){let s=t.getRightLeaf(!1);s&&(await s.setViewState({type:F,active:!0}),n=t.getLeavesOfType(F)[0])}n&&t.revealLeaf(n)}applyTheme(){document.body.classList.remove("llm-wiki-theme-dark-blue","llm-wiki-theme-warm-light","llm-wiki-theme-obsidian-red","llm-wiki-theme-lavender","llm-wiki-theme-forest-green"),document.body.classList.add(`llm-wiki-theme-${this.settings.theme}`)}async loadSettings(){this.settings=Object.assign({},z,await this.loadData())}async saveSettings(){await this.saveData(this.settings),await this.initAgent(),this.memoryService.updateSettings(this.settings)}};
