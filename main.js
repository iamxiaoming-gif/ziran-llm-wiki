...
`)}var F=class{constructor(i,t){this.history=[];this.systemPrompt="";this.settings=i,this.toolRegistry=t}init(i="",t="",e=""){this.systemPrompt=K(this.settings,i,t,e),this.history=[]}setHistory(i){this.history=i}getHistory(){return this.history}clearHistory(){this.history=[]}updateSettings(i){this.settings=i,this.toolRegistry.updateSettings(i)}abort(){}async chatStream(i,t){this.history.push({role:"user",content:i});let e="",n=0,s=this.settings.maxIterations||15;for(;n<s;){n++;let c=[{role:"system",content:this.systemPrompt},...this.history];try{let r=await this.streamCompletion(c,t);if(e=r.content,r.toolCalls.length===0){this.history.push({role:"assistant",content:r.content}),t.onComplete(e);return}this.history.push({role:"assistant",content:r.content||"",tool_calls:r.toolCalls});for(let p of r.toolCalls){let l={};try{let g=JSON.parse(p.function.arguments);l=typeof g=="object"&&g!==null&&!Array.isArray(g)?g:{}}catch(g){l={}}t.onToolCall(p.function.name,l);let u=await this.toolRegistry.executeTool(p.function.name,l);t.onToolResult(p.function.name,u),this.history.push({role:"tool",content:u.content,tool_call_id:p.id,name:p.function.name})}}catch(r){if(r instanceof Error&&r.name==="AbortError"){t.onComplete(e);return}let p=`\u8BF7\u6C42\u5931\u8D25: ${r instanceof Error?r.message:String(r)}`;this.history.push({role:"assistant",content:p}),t.onError(p);return}}let o=`\u5DF2\u8FBE\u5230\u6700\u5927\u8FED\u4EE3\u6B21\u6570(${s})\uFF0C\u8BF7\u7B80\u5316\u95EE\u9898\u6216\u5206\u6B65\u6267\u884C\u3002`;this.history.push({role:"assistant",content:o}),t.onComplete(o)}async streamCompletion(i,t){var u;let e=`${this.settings.apiBaseUrl}/chat/completions`,n={model:this.settings.modelName,messages:i.map(g=>({role:g.role,content:g.content||null,tool_calls:g.tool_calls,tool_call_id:g.tool_call_id,name:g.name})),tools:this.toolRegistry.getToolDefinitions(),tool_choice:"auto",temperature:this.settings.temperature,stream:!1},c=(u=(await(0,V.requestUrl)({url:e,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.settings.apiKey}`},body:JSON.stringify(n)})).json.choices)==null?void 0:u[0];if(!c)throw new Error("API \u8FD4\u56DE\u4E3A\u7A7A");let r=c.message,p=r.content||"",l=r.tool_calls||[];return p&&t.onToken(p),{content:p,toolCalls:l}}async chatNonStream(i,t){this.history.push({role:"user",content:i});let e="",n=0,s=this.settings.maxIterations||15;for(;n<s;){n++;let c=[{role:"system",content:this.systemPrompt},...this.history];try{let r=await this.nonStreamCompletion(c),p=r.content;if(r.toolCalls.length===0){t.onToken(p),this.history.push({role:"assistant",content:p}),e=p,t.onComplete(e);return}this.history.push({role:"assistant",content:p||"",tool_calls:r.toolCalls});for(let l of r.toolCalls){let u={};try{let h=JSON.parse(l.function.arguments);u=typeof h=="object"&&h!==null&&!Array.isArray(h)?h:{}}catch(h){u={}}t.onToolCall(l.function.name,u);let g=await this.toolRegistry.executeTool(l.function.name,u);t.onToolResult(l.function.name,g),this.history.push({role:"tool",content:g.content,tool_call_id:l.id,name:l.function.name})}}catch(r){let p=`\u8BF7\u6C42\u5931\u8D25: ${r instanceof Error?r.message:String(r)}`;this.history.push({role:"assistant",content:p}),t.onError(p);return}}let o=`\u5DF2\u8FBE\u5230\u6700\u5927\u8FED\u4EE3\u6B21\u6570(${s})`;this.history.push({role:"assistant",content:o}),t.onComplete(o)}async nonStreamCompletion(i){var s;let t=`${this.settings.apiBaseUrl}/chat/completions`,e={model:this.settings.modelName,messages:i.map(o=>({role:o.role,content:o.content||null,tool_calls:o.tool_calls,tool_call_id:o.tool_call_id,name:o.name})),tools:this.toolRegistry.getToolDefinitions(),tool_choice:"auto",temperature:this.settings.temperature,stream:!1},n=2;for(let o=0;o<=n;o++)try{let p=(s=(await(0,V.requestUrl)({url:t,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.settings.apiKey}`},body:JSON.stringify(e)})).json.choices)==null?void 0:s[0];if(!p)throw new Error("API \u8FD4\u56DE\u4E3A\u7A7A");let l=p.message;return{content:l.content||"",toolCalls:l.tool_calls||[]}}catch(c){let r=typeof c=="object"&&c!==null&&"status"in c?c.status:0;if(r>=400&&r<500)throw c;if(o<n)await new Promise(p=>window.setTimeout(p,1e3*(o+1)));else throw c}throw new Error("API \u8C03\u7528\u5931\u8D25\uFF08\u5DF2\u91CD\u8BD5\uFF09")}};var a=require("obsidian"),B=class{constructor(i,t){this.tools=new Map;this.app=i,this.settings=t,this.registerAllTools()}getErrorMessage(i){return i instanceof Error?i.message:String(i)}strArgs(i){let t={};for(let[e,n]of Object.entries(i))typeof n=="string"&&(t[e]=n);return t}updateSettings(i){this.settings=i}registerAllTools(){this.registerVaultTools(),this.registerSkillTools(),this.registerMemoryTools()}registerVaultTools(){this.tools.set("read_vault_file",{name:"read_vault_file",description:"\u8BFB\u53D6 Vault \u4E2D\u7684\u6587\u4EF6\u5185\u5BB9",parameters:{type:"object",properties:{path:{type:"string",description:"\u6587\u4EF6\u5728 Vault \u4E2D\u7684\u76F8\u5BF9\u8DEF\u5F84"}},required:["path"]},execute:async i=>{try{let t=this.strArgs(i),e=(0,a.normalizePath)(t.path),n=this.app.vault.getAbstractFileByPath(e);return!n||!(n instanceof a.TFile)?{success:!1,content:`\u6587\u4EF6\u4E0D\u5B58\u5728: ${e}`}:{success:!0,content:await this.app.vault.read(n)}}catch(t){return{success:!1,content:`\u8BFB\u53D6\u6587\u4EF6\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("write_vault_file",{name:"write_vault_file",description:"\u521B\u5EFA\u65B0\u6587\u4EF6\uFF08\u4E0D\u80FD\u5199\u5165 00-\u539F\u59CB\u8D44\u6599/ \u76EE\u5F55\u3002\u5982\u679C\u6587\u4EF6\u5DF2\u5B58\u5728\u5219\u62A5\u9519\uFF09",parameters:{type:"object",properties:{path:{type:"string",description:"\u6587\u4EF6\u5728 Vault \u4E2D\u7684\u76F8\u5BF9\u8DEF\u5F84\uFF08\u5FC5\u987B\u662F\u4E0D\u5B58\u5728\u7684\u8DEF\u5F84\uFF0C\u4E14\u4E0D\u80FD\u5728 00-\u539F\u59CB\u8D44\u6599/ \u4E0B\uFF09"},content:{type:"string",description:"\u6587\u4EF6\u5185\u5BB9"}},required:["path","content"]},execute:async i=>{try{let t=this.strArgs(i),e=(0,a.normalizePath)(t.path),n=this.isUnderRawMaterials(e);if(n)return{success:!1,content:`\u7981\u6B62\u5199\u5165\u539F\u59CB\u8D44\u6599\u76EE\u5F55\uFF1A${n}\u300200-\u539F\u59CB\u8D44\u6599/ \u76EE\u5F55\u53EA\u8BFB\uFF0C\u4E0D\u80FD\u4FEE\u6539\u3002\u5982\u679C\u7528\u6237\u9700\u8981\u79FB\u52A8\u6587\u4EF6\uFF0C\u8BF7\u544A\u77E5\u7528\u6237\u624B\u52A8\u64CD\u4F5C\u3002`};let s=this.app.vault.getAbstractFileByPath(e);return s&&s instanceof a.TFile?{success:!1,content:`\u6587\u4EF6\u5DF2\u5B58\u5728\uFF0C\u7981\u6B62\u8986\u76D6\uFF1A${e}\u3002\u8BF7\u4F7F\u7528 append_vault_file \u8FFD\u52A0\u5185\u5BB9\uFF0C\u6216\u4F7F\u7528 update_knowledge_page \u66F4\u65B0\u9875\u9762\u7AE0\u8282\u3002`}:(await this.ensureFolder(e.substring(0,e.lastIndexOf("/"))),await this.app.vault.create(e,t.content),{success:!0,content:`\u6587\u4EF6\u5DF2\u521B\u5EFA: ${e}`})}catch(t){return{success:!1,content:`\u521B\u5EFA\u6587\u4EF6\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("append_vault_file",{name:"append_vault_file",description:"\u5728 Vault \u6587\u4EF6\u672B\u5C3E\u8FFD\u52A0\u5185\u5BB9\uFF08\u4E0D\u80FD\u4FEE\u6539 00-\u539F\u59CB\u8D44\u6599/ \u76EE\u5F55\u4E0B\u7684\u6587\u4EF6\uFF09",parameters:{type:"object",properties:{path:{type:"string",description:"\u6587\u4EF6\u5728 Vault \u4E2D\u7684\u76F8\u5BF9\u8DEF\u5F84"},content:{type:"string",description:"\u8981\u8FFD\u52A0\u7684\u5185\u5BB9"}},required:["path","content"]},execute:async i=>{try{let t=this.strArgs(i),e=(0,a.normalizePath)(t.path),n=this.isUnderRawMaterials(e);if(n)return{success:!1,content:`\u7981\u6B62\u4FEE\u6539\u539F\u59CB\u8D44\u6599\u76EE\u5F55\uFF1A${n}\u300200-\u539F\u59CB\u8D44\u6599/ \u76EE\u5F55\u53EA\u8BFB\u3002`};let s=this.app.vault.getAbstractFileByPath(e);if(!s||!(s instanceof a.TFile))return{success:!1,content:`\u6587\u4EF6\u4E0D\u5B58\u5728: ${e}`};let o=await this.app.vault.read(s);return await this.app.vault.modify(s,o+`
`+t.content),{success:!0,content:`\u5185\u5BB9\u5DF2\u8FFD\u52A0\u5230: ${e}`}}catch(t){return{success:!1,content:`\u8FFD\u52A0\u5185\u5BB9\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("list_vault_folder",{name:"list_vault_folder",description:"\u5217\u51FA Vault \u6587\u4EF6\u5939\u4E2D\u7684\u6240\u6709\u6587\u4EF6\u548C\u5B50\u6587\u4EF6\u5939",parameters:{type:"object",properties:{path:{type:"string",description:"\u6587\u4EF6\u5939\u5728 Vault \u4E2D\u7684\u76F8\u5BF9\u8DEF\u5F84"}},required:["path"]},execute:async i=>{try{let t=this.strArgs(i),e=(0,a.normalizePath)(t.path),n=this.app.vault.getAbstractFileByPath(e);if(!n||!(n instanceof a.TFolder))return{success:!1,content:`\u6587\u4EF6\u5939\u4E0D\u5B58\u5728: ${e}`};let s=[];for(let o of n.children)o instanceof a.TFile?s.push(`\u{1F4C4} ${o.path} (${o.stat.size} bytes)`):o instanceof a.TFolder&&s.push(`\u{1F4C1} ${o.path}/`);return{success:!0,content:s.length>0?s.join(`
`):"\u6587\u4EF6\u5939\u4E3A\u7A7A"}}catch(t){return{success:!1,content:`\u5217\u51FA\u6587\u4EF6\u5939\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("create_vault_folder",{name:"create_vault_folder",description:"\u5728 Vault \u4E2D\u521B\u5EFA\u6587\u4EF6\u5939\uFF08\u652F\u6301\u9012\u5F52\u521B\u5EFA\uFF09",parameters:{type:"object",properties:{path:{type:"string",description:"\u6587\u4EF6\u5939\u5728 Vault \u4E2D\u7684\u76F8\u5BF9\u8DEF\u5F84"}},required:["path"]},execute:async i=>{try{let t=this.strArgs(i),e=(0,a.normalizePath)(t.path);return await this.ensureFolder(e),{success:!0,content:`\u6587\u4EF6\u5939\u5DF2\u521B\u5EFA: ${e}`}}catch(t){return{success:!1,content:`\u521B\u5EFA\u6587\u4EF6\u5939\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("search_vault_files",{name:"search_vault_files",description:"\u5728 Vault \u4E2D\u641C\u7D22\u6587\u4EF6\u540D\u5305\u542B\u5173\u952E\u8BCD\u7684\u6587\u4EF6",parameters:{type:"object",properties:{query:{type:"string",description:"\u641C\u7D22\u5173\u952E\u8BCD"},folder:{type:"string",description:"\u9650\u5B9A\u641C\u7D22\u7684\u6587\u4EF6\u5939\u8DEF\u5F84\uFF08\u53EF\u9009\uFF09"}},required:["query"]},execute:async i=>{try{let t=this.strArgs(i),e=t.query.toLowerCase(),s=this.app.vault.getFiles().filter(c=>c.path.toLowerCase().includes(e));if(t.folder){let c=(0,a.normalizePath)(t.folder).toLowerCase();s=s.filter(r=>r.path.toLowerCase().startsWith(c))}let o=s.slice(0,50).map(c=>`\u{1F4C4} ${c.path}`);return{success:!0,content:o.length>0?`\u627E\u5230 ${s.length} \u4E2A\u6587\u4EF6:
${o.join(`
`)}`:"\u672A\u627E\u5230\u5339\u914D\u6587\u4EF6"}}catch(t){return{success:!1,content:`\u641C\u7D22\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("search_vault_content",{name:"search_vault_content",description:"\u5728 Vault \u6587\u4EF6\u5185\u5BB9\u4E2D\u641C\u7D22\u5305\u542B\u5173\u952E\u8BCD\u7684\u6587\u4EF6",parameters:{type:"object",properties:{query:{type:"string",description:"\u641C\u7D22\u5185\u5BB9\u5173\u952E\u8BCD"},folder:{type:"string",description:"\u9650\u5B9A\u641C\u7D22\u7684\u6587\u4EF6\u5939\u8DEF\u5F84\uFF08\u53EF\u9009\uFF09"}},required:["query"]},execute:async i=>{try{let t=this.strArgs(i),e=t.query.toLowerCase(),n=this.app.vault.getMarkdownFiles();if(t.folder){let o=(0,a.normalizePath)(t.folder).toLowerCase();n=n.filter(c=>c.path.toLowerCase().startsWith(o))}let s=[];for(let o of n.slice(0,100))(await this.app.vault.cachedRead(o)).toLowerCase().includes(e)&&s.push(`\u{1F4C4} ${o.path}`);return{success:!0,content:s.length>0?`\u627E\u5230 ${s.length} \u4E2A\u6587\u4EF6:
${s.join(`
`)}`:"\u672A\u627E\u5230\u5339\u914D\u5185\u5BB9"}}catch(t){return{success:!1,content:`\u641C\u7D22\u5931\u8D25: ${this.getErrorMessage(t)}`}}}})}registerSkillTools(){this.tools.set("read_skill",{name:"read_skill",description:"\u8BFB\u53D6 SKILL.md \u6587\u4EF6\u6216 references/ \u4E2D\u7684\u53C2\u8003\u6A21\u677F\u6587\u4EF6\u3002\u7528\u4E8E\u968F\u65F6\u67E5\u9605\u77E5\u8BC6\u5E93\u6784\u5EFA\u89C4\u8303\u539F\u6587",parameters:{type:"object",properties:{file:{type:"string",description:"\u8981\u8BFB\u53D6\u7684\u6587\u4EF6\u540D\u3002\u53EF\u9009\u503C\uFF1ASKILL.md\uFF08\u4E3B\u89C4\u8303\uFF09\u3001\u77E5\u8BC6\u70B9\u9875\u9762\u6A21\u677F.md\u3001\u4EBA\u7269\u4F20\u8BB0\u6A21\u677F.md\u3001\u7EC4\u7EC7\u6863\u6848\u6A21\u677F.md\u3001\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15\u6A21\u677F.md\u3001\u66F4\u65B0\u65E5\u5FD7\u6A21\u677F.md\u3001AGENTS-template.md\u3001\u51B2\u7A81\u8BB0\u5F55\u6A21\u677F.md"}},required:["file"]},execute:async i=>{try{let t=this.strArgs(i),e=(0,a.normalizePath)(this.settings.skillFolderPath),n=`${e}/references`,s;t.file==="SKILL.md"?s=`${e}/SKILL.md`:s=`${n}/${t.file}`;let o=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(s));return!o||!(o instanceof a.TFile)?{success:!1,content:`\u6587\u4EF6\u4E0D\u5B58\u5728: ${s}\u3002Skill \u6587\u4EF6\u5939\u8DEF\u5F84: ${this.settings.skillFolderPath}`}:{success:!0,content:await this.app.vault.read(o)}}catch(t){return{success:!1,content:`\u8BFB\u53D6\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("init_knowledge_base",{name:"init_knowledge_base",description:"\u521D\u59CB\u5316\u4E13\u9898\u77E5\u8BC6\u5E93\u76EE\u5F55\u7ED3\u6784\uFF0C\u521B\u5EFA\u6240\u6709\u5FC5\u9700\u7684\u6587\u4EF6\u5939\u548C\u521D\u59CB\u7D22\u5F15\u6587\u4EF6",parameters:{type:"object",properties:{topic_name:{type:"string",description:"\u4E13\u9898\u540D\u79F0\uFF0C\u5982'\u5DF4\u83F2\u7279\u6295\u8D44'\u3001'Python\u7F16\u7A0B'"},categories:{type:"string",description:"\u77E5\u8BC6\u70B9\u5E93\u5206\u7C7B\uFF0C\u9017\u53F7\u5206\u9694\uFF0C\u5982'\u6838\u5FC3\u6982\u5FF5,\u65B9\u6CD5\u8BBA,\u7ECF\u5178\u6848\u4F8B,\u4EBA\u7269\u4F20\u8BB0,\u7EC4\u7EC7\u6863\u6848,\u884C\u4E1A\u5206\u6790'"},raw_categories:{type:"string",description:"\u539F\u59CB\u8D44\u6599\u5206\u7C7B\uFF0C\u9017\u53F7\u5206\u9694\uFF0C\u5982'\u81F4\u80A1\u4E1C\u4FE1,\u80A1\u4E1C\u5927\u4F1A\u6F14\u8BB2'"}},required:["topic_name"]},execute:async i=>{try{let t=this.strArgs(i),e=(0,a.normalizePath)(this.settings.knowledgeBasePath),n=(t.categories||"\u6838\u5FC3\u6982\u5FF5,\u65B9\u6CD5\u8BBA,\u7ECF\u5178\u6848\u4F8B,\u4EBA\u7269\u4F20\u8BB0,\u7EC4\u7EC7\u6863\u6848,\u884C\u4E1A\u5206\u6790").split(","),s=(t.raw_categories||"\u8D44\u6599\u5206\u7C7B1,\u8D44\u6599\u5206\u7C7B2").split(","),o=[e,`${e}/00-\u539F\u59CB\u8D44\u6599`,`${e}/00-\u539F\u59CB\u8D44\u6599/assets`,`${e}/10-\u77E5\u8BC6\u70B9\u5E93`,`${e}/20-\u77E5\u8BC6\u7D22\u5F15`,`${e}/30-\u7EF4\u62A4\u8BB0\u5F55`];for(let h of s)o.push(`${e}/00-\u539F\u59CB\u8D44\u6599/${h.trim()}`);for(let h of n)o.push(`${e}/10-\u77E5\u8BC6\u70B9\u5E93/${h.trim()}`);for(let h of o)await this.ensureFolder(h);let c=`# ${t.topic_name}\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15
...
`;await this.createFileOnly(`${e}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,c);let r=`# ${t.topic_name}\u5173\u952E\u8BCD\u7D22\u5F15

| \u5173\u952E\u8BCD | \u76F8\u5173\u77E5\u8BC6\u70B9 | \u51FA\u73B0\u6B21\u6570 |
|--------|-----------|----------|

\uFF08\u6682\u65E0\u5173\u952E\u8BCD\uFF09
`;await this.createFileOnly(`${e}/20-\u77E5\u8BC6\u7D22\u5F15/\u5173\u952E\u8BCD\u7D22\u5F15.md`,r);let p=`# ${t.topic_name}\u77E5\u8BC6\u70B9\u5173\u7CFB\u56FE\u8C31
...
\u73B0\u5728\u53EF\u4EE5\u5F00\u59CB\u653E\u5165\u539F\u59CB\u8D44\u6599\u5E76\u6267\u884C\u6444\u53D6\u5DE5\u4F5C\u6D41\u4E86\uFF01`}}catch(t){return{success:!1,content:`\u521D\u59CB\u5316\u77E5\u8BC6\u5E93\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("ingest_raw_material",{name:"ingest_raw_material",description:"\u6444\u53D6\u539F\u59CB\u8D44\u6599\uFF1A\u8BFB\u53D6\u539F\u59CB\u8D44\u6599\u6587\u4EF6\uFF0C\u8FD4\u56DE\u5B8C\u6574\u5185\u5BB9\u4F9BLLM\u63D0\u70BC\u77E5\u8BC6\u70B9\u3002\u8BFB\u53D6\u540ELLM\u5FC5\u987B\u6267\u884C\u5B8C\u6574\u5DE5\u4F5C\u6D41\uFF1A\u63D0\u70BC\u2192\u521B\u5EFA\u9875\u9762\u2192\u66F4\u65B0\u7D22\u5F15\u2192\u8FFD\u52A0\u65E5\u5FD7\u3002\u8BF7\u4F7F\u7528 create_and_index_page \u4E00\u7AD9\u5F0F\u5B8C\u6210",parameters:{type:"object",properties:{file_path:{type:"string",description:"\u539F\u59CB\u8D44\u6599\u6587\u4EF6\u8DEF\u5F84\uFF08\u5FC5\u987B\u662F\u4EE5 00-\u539F\u59CB\u8D44\u6599/ \u5F00\u5934\u7684\u8DEF\u5F84\uFF09"},focus_topics:{type:"string",description:"\u91CD\u70B9\u5173\u6CE8\u7684\u77E5\u8BC6\u70B9\u4E3B\u9898\uFF0C\u9017\u53F7\u5206\u9694\uFF08\u53EF\u9009\uFF09"}},required:["file_path"]},execute:async i=>{try{let t=this.strArgs(i),e=(0,a.normalizePath)(t.file_path),n=this.app.vault.getAbstractFileByPath(e);if(!n||!(n instanceof a.TFile))return{success:!1,content:`\u539F\u59CB\u8D44\u6599\u6587\u4EF6\u4E0D\u5B58\u5728: ${e}`};let s=await this.app.vault.read(n),o=s.length>8e3?s.substring(0,8e3)+`
...
- \u521B\u5EFA/\u66F4\u65B0\u4E86\u54EA\u4E9B\u77E5\u8BC6\u70B9\u9875\u9762
- \u66F4\u65B0\u4E86\u54EA\u4E9B\u7D22\u5F15
- \u5F53\u524D\u77E5\u8BC6\u5E93\u6982\u51B5\uFF08\u6587\u4EF6\u6570\u3001\u6210\u719F\u5EA6\uFF09`}}catch(t){return{success:!1,content:`\u6444\u53D6\u8D44\u6599\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("create_knowledge_page",{name:"create_knowledge_page",description:"\u521B\u5EFA\u77E5\u8BC6\u70B9\u9875\u9762\u3002\u63A8\u8350\u4F18\u5148\u4F7F\u7528 create_and_index_page \u4E00\u7AD9\u5F0F\u521B\u5EFA+\u7D22\u5F15+\u65E5\u5FD7\u3002\u63A8\u8350\u53EA\u4F20 title + category + content(\u5B8C\u6574markdown) \u4E09\u4E2A\u53C2\u6570\uFF0C\u81EA\u52A8\u5957\u7528\u6A21\u677F",parameters:{type:"object",properties:{category:{type:"string",description:"\u77E5\u8BC6\u70B9\u5206\u7C7B\uFF0C\u5982\uFF1A\u6838\u5FC3\u6982\u5FF5\u3001\u65B9\u6CD5\u8BBA\u3001\u7ECF\u5178\u6848\u4F8B\u3001\u884C\u4E1A\u5206\u6790"},title:{type:"string",description:"\u77E5\u8BC6\u70B9\u540D\u79F0"},definition:{type:"string",description:"\u4E00\u53E5\u8BDD\u5B9A\u4E49\uFF08\u53EF\u9009\uFF0C\u6709content\u65F6\u5FFD\u7565\uFF09"},core_content:{type:"string",description:"\u6838\u5FC3\u5B9A\u4E49\u5185\u5BB9\uFF08\u53EF\u9009\uFF0C\u6709content\u65F6\u5FFD\u7565\uFF09"},content:{type:"string",description:"\u5B8C\u6574markdown\u5185\u5BB9\uFF08\u53EF\u9009\uFF0C\u63D0\u4F9B\u540E\u5FFD\u7565\u5176\u4ED6\u683C\u5F0F\u5316\u53C2\u6570\uFF09\u3002\u63A8\u8350\u4F7F\u7528\u6B64\u53C2\u6570\uFF0C\u76F4\u63A5\u5C06\u5B8C\u6574\u76849\u7AE0markdown\u4F20\u5165"},key_points:{type:"string",description:"\u6838\u5FC3\u8981\u70B9\uFF08\u53EF\u9009\uFF0C\u6709content\u65F6\u5FFD\u7565\uFF09"},cases:{type:"string",description:"\u7ECF\u5178\u6848\u4F8B\uFF08\u53EF\u9009\uFF0C\u6709content\u65F6\u5FFD\u7565\uFF09"},methods:{type:"string",description:"\u5B9E\u8DF5\u65B9\u6CD5\uFF08\u53EF\u9009\uFF0C\u6709content\u65F6\u5FFD\u7565\uFF09"},misconceptions:{type:"string",description:"\u5E38\u89C1\u8BEF\u533A\uFF08\u53EF\u9009\uFF0C\u6709content\u65F6\u5FFD\u7565\uFF09"},related_topics:{type:"string",description:"\u76F8\u5173\u77E5\u8BC6\u70B9\uFF0C\u9017\u53F7\u5206\u9694\uFF08\u53EF\u9009\uFF09"},source_refs:{type:"string",description:"\u539F\u6587\u51FA\u5904\u8DEF\u5F84\uFF0C\u9017\u53F7\u5206\u9694\uFF08\u53EF\u9009\uFF09"},insights:{type:"string",description:"\u5BF9\u76EE\u6807\u4EBA\u7FA4\u7684\u542F\u793A\uFF08\u53EF\u9009\uFF09"},maturity:{type:"string",description:"\u6210\u719F\u5EA6\u7EA7\u522B",enum:["\u5B8C\u6574\u7EA7","\u57FA\u7840\u7EA7","\u6846\u67B6\u7EA7"]}},required:["category","title"]},execute:async i=>{try{let t=this.strArgs(i),n=`${(0,a.normalizePath)(this.settings.knowledgeBasePath)}/10-\u77E5\u8BC6\u70B9\u5E93/${t.category}`;await this.ensureFolder(n);let s=new Date().toISOString().split("T")[0],o=`${n}/${t.title}.md`,c=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(o));if(c&&c instanceof a.TFile)return{success:!1,content:`\u77E5\u8BC6\u70B9\u9875\u9762\u5DF2\u5B58\u5728\uFF0C\u7981\u6B62\u8986\u76D6\uFF1A${o}\u3002\u8BF7\u4F7F\u7528 update_knowledge_page \u8FFD\u52A0\u5185\u5BB9\u3002`};if(t.content)return await this.createFileOnly(o,t.content),{success:!0,content:`\u77E5\u8BC6\u70B9\u9875\u9762\u5DF2\u521B\u5EFA: ${o}\uFF08\u4F7F\u7528\u5B8C\u6574markdown\u5185\u5BB9\uFF09

\u63A5\u4E0B\u6765\u5FC5\u987B\u6267\u884C\uFF1A
1. \u4F7F\u7528 update_index \u5DE5\u5177 update_index action=add_entry \u4EE5\u66F4\u65B0\u7D22\u5F15
2. \u4F7F\u7528 append_vault_file \u8FFD\u52A0\u66F4\u65B0\u65E5\u5FD7\u5230 30-\u7EF4\u62A4\u8BB0\u5F55/\u77E5\u8BC6\u5E93\u66F4\u65B0\u65E5\u5FD7.md

\u6216\u8005\u76F4\u63A5\u4F7F\u7528 create_and_index_page \u4E00\u7AD9\u5F0F\u5B8C\u6210\u4E0A\u8FF0\u5168\u90E8\u6B65\u9AA4\u3002`};let r=t.maturity?`${t.maturity}`:"\u57FA\u7840\u7EA7",p=r.includes("\u5B8C\u6574")?"\u{1F7E2}":r.includes("\u6846\u67B6")?"\u{1F534}":"\u{1F7E1}",l=`### \u8981\u70B91\uFF1A[\u5F85\u8865\u5145]
...
`+J+`
`+y.substring(A);await this.app.vault.modify(d,q);let N=q.match(/知识点总数：(\d+)个/);if(N){let G=parseInt(N[1])+1;await this.app.vault.modify(d,q.replace(`\u77E5\u8BC6\u70B9\u603B\u6570\uFF1A${N[1]}\u4E2A`,`\u77E5\u8BC6\u70B9\u603B\u6570\uFF1A${G}\u4E2A`))}}if(n.keywords){let b=`${s}/20-\u77E5\u8BC6\u7D22\u5F15/\u5173\u952E\u8BCD\u7D22\u5F15.md`,P=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(b));if(P&&P instanceof a.TFile){let A=await this.app.vault.read(P),M=n.keywords.split(",").map(E=>`| ${E.trim()} | [[${n.title}]] | 1 |`).join(`
`);await this.app.vault.modify(P,A.replace("\uFF08\u6682\u65E0\u5173\u952E\u8BCD\uFF09",M))}}}let m=`${s}/30-\u7EF4\u62A4\u8BB0\u5F55/\u77E5\u8BC6\u5E93\u66F4\u65B0\u65E5\u5FD7.md`,w=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(m)),f=`
## ${o} | \u65B0\u5EFA\u77E5\u8BC6\u70B9\uFF1A${n.title}
...
---
`;if(w&&w instanceof a.TFile){let y=await this.app.vault.read(w);await this.app.vault.modify(w,y+f)}else await this.createFileOnly(m,`# \u77E5\u8BC6\u5E93\u66F4\u65B0\u65E5\u5FD7
...
|------|---------|---------|----------|
| ${s} | \u521B\u5EFA | \u7528\u6237\u6307\u4EE4 | \u521D\u59CB\u5316\u9875\u9762 |
`,g=`${n}/${t.name}.md`,h=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(g));return h&&h instanceof a.TFile?{success:!1,content:`\u7EC4\u7EC7\u6863\u6848\u9875\u9762\u5DF2\u5B58\u5728\uFF0C\u7981\u6B62\u8986\u76D6\uFF1A${g}\u3002\u8BF7\u4F7F\u7528 update_knowledge_page \u8FFD\u52A0\u5185\u5BB9\u3002`}:(await this.createFileOnly(g,u),{success:!0,content:`\u7EC4\u7EC7\u6863\u6848\u9875\u9762\u5DF2\u521B\u5EFA: ${g}

\u8BF7\u7EE7\u7EED\u6267\u884C\uFF1A
1. \u4F7F\u7528 update_index \u5DE5\u5177\u66F4\u65B0\u7D22\u5F15
2. \u5728\u81F3\u5C113\u4E2A\u5DF2\u6709\u9875\u9762\u4E2D\u6DFB\u52A0\u5165\u94FE
3. \u8FFD\u52A0\u66F4\u65B0\u65E5\u5FD7`})}catch(t){return{success:!1,content:`\u521B\u5EFA\u7EC4\u7EC7\u6863\u6848\u9875\u9762\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("update_knowledge_page",{name:"update_knowledge_page",description:"\u5411\u5DF2\u6709\u7684\u77E5\u8BC6\u70B9\u9875\u9762\u8FFD\u52A0\u5185\u5BB9\u3002\u4E0D\u53EF\u66FF\u6362\u6216\u5220\u9664\u5DF2\u6709\u5185\u5BB9",parameters:{type:"object",properties:{path:{type:"string",description:"\u77E5\u8BC6\u70B9\u9875\u9762\u7684\u8DEF\u5F84"},section:{type:"string",description:"\u8981\u66F4\u65B0\u7684\u7AE0\u8282\u6838\u5FC3\u540D\u79F0\uFF0C\u5982\uFF1A\u6838\u5FC3\u5B9A\u4E49\u3001\u6838\u5FC3\u8981\u70B9\u3001\u7ECF\u5178\u6848\u4F8B\u3001\u5B9E\u8DF5\u65B9\u6CD5\u3001\u5E38\u89C1\u8BEF\u533A\u3001\u76F8\u5173\u77E5\u8BC6\u70B9\u3001\u539F\u6587\u51FA\u5904\u3001\u542F\u793A\u3001\u66F4\u65B0\u65E5\u5FD7"},content:{type:"string",description:"\u8981\u8FFD\u52A0\u7684\u7AE0\u8282\u5185\u5BB9\uFF08\u53EA\u5199\u7AE0\u8282\u5185\u5BB9\u672C\u8EAB\uFF0C\u4E0D\u5305\u542B\u7AE0\u8282\u6807\u9898\uFF09"},append_mode:{type:"string",description:"\u56FA\u5B9A\u4E3A append\uFF08\u5728\u7AE0\u8282\u672B\u5C3E\u8FFD\u52A0\u5185\u5BB9\uFF09\u3002\u6CE8\u610F\uFF1A\u4E0D\u652F\u6301 replace\uFF0C\u4E0D\u5F97\u5220\u9664\u5DF2\u6709\u5185\u5BB9",enum:["append"]}},required:["path","section","content"]},execute:async i=>{try{let t=this.strArgs(i),e=(0,a.normalizePath)(t.path),n=this.app.vault.getAbstractFileByPath(e);if(!n||!(n instanceof a.TFile))return{success:!1,content:`\u6587\u4EF6\u4E0D\u5B58\u5728: ${e}`};let s=await this.app.vault.read(n),c={\u6838\u5FC3\u5B9A\u4E49:["\u6838\u5FC3\u5B9A\u4E49","\u6838\u5FC3\u5B9A\u4E49"],\u6838\u5FC3\u8981\u70B9:["\u6838\u5FC3\u8981\u70B9","\u8981\u70B9"],\u7ECF\u5178\u6848\u4F8B:["\u7ECF\u5178\u6848\u4F8B","\u6848\u4F8B"],\u5B9E\u8DF5\u65B9\u6CD5:["\u5B9E\u8DF5\u65B9\u6CD5","\u65B9\u6CD5"],\u5E38\u89C1\u8BEF\u533A:["\u5E38\u89C1\u8BEF\u533A","\u8BEF\u533A"],\u76F8\u5173\u77E5\u8BC6\u70B9:["\u76F8\u5173\u77E5\u8BC6\u70B9","\u5173\u8054"],\u539F\u6587\u51FA\u5904:["\u539F\u6587\u51FA\u5904","\u51FA\u5904"],\u542F\u793A:["\u542F\u793A","\u5BF9\u76EE\u6807\u4EBA\u7FA4\u7684\u542F\u793A"],\u66F4\u65B0\u65E5\u5FD7:["\u66F4\u65B0\u65E5\u5FD7","\u65E5\u5FD7"]}[t.section]||[t.section],r=-1,p="";for(let T of c){let v=new RegExp(`##\\s*[\\d\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u3001\\.]*\\s*${T.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}`),b=s.match(v);if(b){r=b.index,p=b[0];break}}if(r===-1){let T=new RegExp(`##\\s*[\\d\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u3001\\.]*\\s*${t.section.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}`),v=s.match(T);if(v)r=v.index,p=v[0];else return{success:!1,content:`\u672A\u627E\u5230\u7AE0\u8282\u300C${t.section}\u300D\u3002\u6587\u4EF6\u4E2D\u7684\u7AE0\u8282\u6807\u9898\u683C\u5F0F\u53EF\u80FD\u4E0D\u540C\uFF0C\u8BF7\u5148\u4F7F\u7528 read_vault_file \u8BFB\u53D6\u6587\u4EF6\u67E5\u770B\u5B9E\u9645\u7AE0\u8282\u540D\u79F0`}}let l=s.indexOf(`
## `,r+p.length),u=l===-1?s.length:l,g=s.substring(0,r),h=s.substring(u),d=s.substring(r,u),m=g+d+`
...
\u8BF7\u6267\u884C\u81EA\u68C0\u6E05\u5355\u5E76\u66F4\u65B0\u96C6\u4E2D\u65E5\u5FD7\u3002`}}catch(t){return{success:!1,content:`\u66F4\u65B0\u77E5\u8BC6\u70B9\u9875\u9762\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("update_index",{name:"update_index",description:"\u66F4\u65B0\u77E5\u8BC6\u5E93\u7D22\u5F15\u6587\u4EF6\uFF08\u603B\u7D22\u5F15\u3001\u5173\u952E\u8BCD\u7D22\u5F15\u3001\u5173\u7CFB\u56FE\u8C31\uFF09",parameters:{type:"object",properties:{action:{type:"string",description:"\u66F4\u65B0\u7C7B\u578B",enum:["add_entry","refresh_all"]},entry_name:{type:"string",description:"\u6761\u76EE\u540D\u79F0"},entry_category:{type:"string",description:"\u6761\u76EE\u5206\u7C7B"},entry_description:{type:"string",description:"\u4E00\u53E5\u8BDD\u63CF\u8FF0"},entry_maturity:{type:"string",description:"\u6210\u719F\u5EA6",enum:["\u{1F7E2}","\u{1F7E1}","\u{1F534}"]},keywords:{type:"string",description:"\u65B0\u589E\u5173\u952E\u8BCD\uFF0C\u9017\u53F7\u5206\u9694"}},required:["action"]},execute:async i=>{try{let t=this.strArgs(i),e=(0,a.normalizePath)(this.settings.knowledgeBasePath),n=`${e}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,s=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(n));if(!s||!(s instanceof a.TFile))return{success:!1,content:`\u7D22\u5F15\u6587\u4EF6\u4E0D\u5B58\u5728: ${n}`};if(t.action==="add_entry"&&t.entry_name&&t.entry_category){let o=await this.app.vault.read(s),c=t.entry_category,r=new RegExp(`###\\s+\\d+\\.\\s+${c.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}\\s*\\(\\d+\u4E2A\\)`),p=o.match(r);if(p){let l=o.indexOf(p[0]),u=o.indexOf(`
### `,l+1),g=u===-1?o.indexOf(`
...
`+C+`
`+o.substring(g);await this.app.vault.modify(s,T);let v=T.match(/知识点总数：(\d+)个/);if(v){let b=parseInt(v[1])+1,P=T.replace(`\u77E5\u8BC6\u70B9\u603B\u6570\uFF1A${v[1]}\u4E2A`,`\u77E5\u8BC6\u70B9\u603B\u6570\uFF1A${b}\u4E2A`);await this.app.vault.modify(s,P)}}if(t.keywords){let l=`${e}/20-\u77E5\u8BC6\u7D22\u5F15/\u5173\u952E\u8BCD\u7D22\u5F15.md`,u=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(l));if(u&&u instanceof a.TFile){let g=await this.app.vault.read(u),h=t.keywords.split(",").map(m=>`| ${m.trim()} | [[${t.entry_name}]] | 1 |`).join(`
`),d=g.replace("\uFF08\u6682\u65E0\u5173\u952E\u8BCD\uFF09",h);await this.app.vault.modify(u,d)}}return{success:!0,content:`\u7D22\u5F15\u5DF2\u66F4\u65B0\uFF1A\u6DFB\u52A0 ${t.entry_name} \u5230 ${t.entry_category}`}}return t.action==="refresh_all"?{success:!0,content:"\u8BF7\u4F7F\u7528 list_vault_folder \u5DE5\u5177\u626B\u63CF\u5404\u5206\u7C7B\u76EE\u5F55\uFF0C\u7136\u540E\u624B\u52A8\u66F4\u65B0\u7D22\u5F15\u6570\u91CF\u3002"}:{success:!0,content:"\u7D22\u5F15\u66F4\u65B0\u64CD\u4F5C\u5B8C\u6210"}}catch(t){return{success:!1,content:`\u66F4\u65B0\u7D22\u5F15\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("query_knowledge",{name:"query_knowledge",description:"\u67E5\u8BE2\u77E5\u8BC6\u5E93\uFF1A\u5148\u8BFB\u53D6\u7D22\u5F15\u4E86\u89E3\u7ED3\u6784\uFF0C\u518D\u8BFB\u53D6\u76F8\u5173\u77E5\u8BC6\u70B9\u9875\u9762",parameters:{type:"object",properties:{query:{type:"string",description:"\u67E5\u8BE2\u95EE\u9898\u6216\u5173\u952E\u8BCD"}},required:["query"]},execute:async i=>{try{let t=this.strArgs(i),n=`${(0,a.normalizePath)(this.settings.knowledgeBasePath)}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,s=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(n));if(!s||!(s instanceof a.TFile))return{success:!1,content:`\u77E5\u8BC6\u5E93\u7D22\u5F15\u4E0D\u5B58\u5728\uFF0C\u8BF7\u5148\u521D\u59CB\u5316\u77E5\u8BC6\u5E93\u3002\u7D22\u5F15\u8DEF\u5F84: ${n}`};let o=await this.app.vault.read(s),c=t.query.toLowerCase(),r=o.split(`
`),p=[];for(let u of r)u.includes("[[")&&u.toLowerCase().includes(c.split(" ")[0])&&p.push(u.trim());let l=`\u77E5\u8BC6\u5E93\u7D22\u5F15\u6982\u89C8:
${o.substring(0,2e3)}
...
`,l+="\u8BF7\u6839\u636E\u4EE5\u4E0A\u7D22\u5F15\u4FE1\u606F\uFF0C\u4F7F\u7528 read_vault_file \u5DE5\u5177\u8BFB\u53D6\u76F8\u5173\u77E5\u8BC6\u70B9\u9875\u9762\u7684\u8BE6\u7EC6\u5185\u5BB9\u6765\u56DE\u7B54\u7528\u6237\u95EE\u9898\u3002",{success:!0,content:l}}catch(t){return{success:!1,content:`\u67E5\u8BE2\u77E5\u8BC6\u5E93\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("lint_knowledge_base",{name:"lint_knowledge_base",description:"\u5BF9\u77E5\u8BC6\u5E93\u6267\u884C\u6574\u7406\u68C0\u67E5\uFF1A\u68C0\u67E5\u77DB\u76FE\u3001\u5B64\u7ACB\u9875\u9762\u3001\u683C\u5F0F\u95EE\u9898\u7B49",parameters:{type:"object",properties:{check_type:{type:"string",description:"\u68C0\u67E5\u7C7B\u578B",enum:["full","format","content","links"]}},required:[]},execute:async i=>{try{let t=this.strArgs(i),e=(0,a.normalizePath)(this.settings.knowledgeBasePath),n=t.check_type||"full",s=[],o=`${e}/10-\u77E5\u8BC6\u70B9\u5E93`,c=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(o));if(!c||!(c instanceof a.TFolder))return{success:!1,content:`\u77E5\u8BC6\u70B9\u5E93\u76EE\u5F55\u4E0D\u5B58\u5728: ${o}`};let r=[],p=[],l=new Set,u=h=>{for(let d of h.children)d instanceof a.TFile?(r.push(d),l.add(d.basename),d.stat.size===0&&p.push(d)):d instanceof a.TFolder&&u(d)};if(u(c),p.length>0&&s.push(`\u26A0\uFE0F \u53D1\u73B0 ${p.length} \u4E2A\u7A7A\u6587\u4EF6:
${p.map(h=>`  - ${h.path}`).join(`
`)}`),n==="full"||n==="links"){let h=[],d=new Set;for(let m of r.slice(0,50)){let f=(await this.app.vault.cachedRead(m)).matchAll(/\[\[([^\]]+)\]\]/g);for(let y of f)d.add(y[1].split("|")[0].split("#")[0].trim())}for(let m of l)d.has(m)||h.push(m);h.length>0&&s.push(`\u{1F517} \u53D1\u73B0 ${h.length} \u4E2A\u5B64\u7ACB\u9875\u9762\uFF08\u65E0\u5165\u94FE\uFF09:
${h.slice(0,20).map(m=>`  - ${m}`).join(`
`)}`)}if(n==="full"||n==="format")for(let h of r.slice(0,30)){let d=await this.app.vault.cachedRead(h);d.includes("## \u4E5D\u3001\u66F4\u65B0\u65E5\u5FD7")||s.push(`\u{1F4DD} ${h.basename} \u7F3A\u5C11"\u66F4\u65B0\u65E5\u5FD7"\u7AE0\u8282`),d.includes("## \u4E03\u3001\u539F\u6587\u51FA\u5904")||s.push(`\u{1F4DD} ${h.basename} \u7F3A\u5C11"\u539F\u6587\u51FA\u5904"\u7AE0\u8282`)}if(n==="full"||n==="content"){let h=`${e}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,d=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(h));if(d&&d instanceof a.TFile){let w=(await this.app.vault.read(d)).matchAll(/\((\d+)个\)/g);for(let f of w)parseInt(f[1])>0&&s.push(`\u{1F4CA} \u5206\u7C7B\u8BA1\u6570 ${f[0]} \u9700\u8981\u9A8C\u8BC1\u662F\u5426\u4E0E\u5B9E\u9645\u6587\u4EF6\u6570\u4E00\u81F4`)}}return{success:!0,content:s.length>0?`Lint \u68C0\u67E5\u5B8C\u6210\uFF0C\u53D1\u73B0 ${s.length} \u4E2A\u95EE\u9898:
...
\u5171\u68C0\u67E5 ${r.length} \u4E2A\u6587\u4EF6\u3002`}}catch(t){return{success:!1,content:`Lint \u68C0\u67E5\u5931\u8D25: ${this.getErrorMessage(t)}`}}}}),this.tools.set("get_knowledge_base_status",{name:"get_knowledge_base_status",description:"\u83B7\u53D6\u77E5\u8BC6\u5E93\u5F53\u524D\u72B6\u6001\uFF1A\u6587\u4EF6\u6570\u91CF\u3001\u6210\u719F\u5EA6\u5206\u5E03\u3001\u6700\u8FD1\u66F4\u65B0\u7B49",parameters:{type:"object",properties:{},required:[]},execute:async()=>{try{let i=(0,a.normalizePath)(this.settings.knowledgeBasePath),t=this.app.vault.getAbstractFileByPath(i);if(!t||!(t instanceof a.TFolder))return{success:!1,content:`\u77E5\u8BC6\u5E93\u5C1A\u672A\u521D\u59CB\u5316\u3002\u8DEF\u5F84: ${i}

\u8BF7\u4F7F\u7528 init_knowledge_base \u5DE5\u5177\u521D\u59CB\u5316\u77E5\u8BC6\u5E93\u3002`};let e={},n={"\u{1F7E2}":0,"\u{1F7E1}":0,"\u{1F534}":0},s=u=>{let g=0;for(let h of u.children)h instanceof a.TFile?g++:h instanceof a.TFolder&&(g+=s(h));return g};for(let u of t.children)u instanceof a.TFolder&&(e[u.name]=s(u));let o=`${i}/10-\u77E5\u8BC6\u70B9\u5E93`,c=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(o));if(c&&c instanceof a.TFolder){for(let u of c.children)if(u instanceof a.TFolder){for(let g of u.children)if(g instanceof a.TFile){let h=await this.app.vault.cachedRead(g);h.includes("\u{1F7E2}")?n["\u{1F7E2}"]++:h.includes("\u{1F7E1}")?n["\u{1F7E1}"]++:h.includes("\u{1F534}")&&n["\u{1F534}"]++}}}let r=`${i}/20-\u77E5\u8BC6\u7D22\u5F15/\u77E5\u8BC6\u5E93\u603B\u7D22\u5F15.md`,p=this.app.vault.getAbstractFileByPath((0,a.normalizePath)(r)),l="\u672A\u77E5";return p&&p instanceof a.TFile&&(l=new Date(p.stat.mtime).toLocaleString("zh-CN")),{success:!0,content:`\u{1F4CA} \u77E5\u8BC6\u5E93\u72B6\u6001\u62A5\u544A
...
\u{1F4C8} \u6210\u719F\u5EA6\u5206\u5E03:
  ...
  - \u{1F534} \u6846\u67B6\u7EA7: ${n["\u{1F534}"]}\u4E2A`}}catch(i){return{success:!1,content:`\u83B7\u53D6\u77E5\u8BC6\u5E93\u72B6\u6001\u5931\u8D25: ${this.getErrorMessage(i)}`}}}}),this.tools.set("record_conflict",{name:"record_conflict",description:"\u8BB0\u5F55\u77E5\u8BC6\u70B9\u4E4B\u95F4\u7684\u77DB\u76FE/\u51B2\u7A81",parameters:{type:"object",properties:{old_info:{type:"string",description:"\u65E7\u4FE1\u606F"},new_info:{type:"string",description:"\u65B0\u4FE1\u606F"},old_source:{type:"string",description:"\u65E7\u4FE1\u606F\u6765\u6E90\u8DEF\u5F84"},new_source:{type:"string",description:"\u65B0\u4FE1\u606F\u6765\u6E90\u8DEF\u5F84"},resolution:{type:"string",description:"\u5904\u7406\u65B9\u5F0F",enum:["\u6807\u6CE8\u77DB\u76FE","\u4EE5\u65B0\u4E3A\u51C6","\u9700\u9A8C\u8BC1"]}},required:["old_info","new_info"]},execute:async i=>{try{let t=this.strArgs(i),n=`${(0,a.normalizePath)(this.settings.knowledgeBasePath)}/30-\u7EF4\u62A4\u8BB0\u5F55/\u51B2\u7A81\u4E0E\u9519\u8BEF\u8BB0\u5F55.md`,s=new Date().toISOString().split("T")[0],o=`
## \u26A0\uFE0F \u77E5\u8BC6\u70B9\u77DB\u76FE\u8BB0\u5F55 (${s})
...
---
`,c=this.app.vault.getAbstractFileByPath(s);if(c&&c instanceof k.TFile){let r=await this.app.vault.read(c);await this.app.vault.modify(c,r+o)}else await this.ensureFolder(`${this.settings.memoryFolder}/\u65E5\u5FD7`),await this.app.vault.create(s,`# \u5DE5\u4F5C\u65E5\u5FD7 ${n}
...
`);if(this.estimateTokens(e)<=this.maxTokens)return i;let n=[],s=[];for(let g of i)s.push(g),g.role==="assistant"&&!g.tool_calls&&(n.push([...s]),s=[]);if(s.length>0&&n.push(s),n.length<=6)return i;let o=n.slice(-6),r=n.slice(0,-6).flat().map(g=>`${g.role}: ${g.content||""}`).join(`
`),p=this.hashText(r),l=this.summaryCache.get(p);if(!l)try{l=await t([{role:"system",content:"\u5C06\u4EE5\u4E0B\u5BF9\u8BDD\u5386\u53F2\u538B\u7F29\u4E3A\u4E00\u6BB5\u7B80\u6D01\u7684\u6458\u8981\uFF0C\u4FDD\u7559\u5173\u952E\u4FE1\u606F\u3001\u51B3\u7B56\u548C\u7ED3\u8BBA\uFF0C\u4E0D\u8D85\u8FC7500\u5B57\u3002\u5982\u679C\u6D89\u53CA\u77E5\u8BC6\u70B9\u5E93\u7684\u64CD\u4F5C\uFF0C\u4FDD\u7559\u6587\u4EF6\u8DEF\u5F84\u548C\u64CD\u4F5C\u7C7B\u578B\u3002"},{role:"user",content:r}]),this.summaryCache.set(p,l)}catch(g){l=`[\u65E9\u671F\u5BF9\u8BDD\u6458\u8981: ${r.substring(0,500)}...]`}return[{role:"assistant",content:`[\u5386\u53F2\u5BF9\u8BDD\u6458\u8981]
